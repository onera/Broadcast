...
! =============================================================================
!
SUBROUTINE FLUX_NUM_DNC3_POLAR_2D_D(residu, residud, w, wd, ym, x0, y0, &
...
&       , 1)+fd(i-2, j, 1))) + ny(i, j, 1)*(c1*(gd(i, j, 1)+gd(i-1, j, 1&
&       ))+c2*(gd(i+1, j, 1)+gd(i-2, j, 1)))
      fxrou1d = nx(i, j, 1)*(c1*(fd(i, j, 2)+fd(i-1, j, 2))+c2*(fd(i+1, &
&       j, 2)+fd(i-2, j, 2))) + ny(i, j, 1)*(c1*(gd(i, j, 2)+gd(i-1, j, &
&       2))+c2*(gd(i+1, j, 2)+gd(i-2, j, 2)))
      fxrov1d = nx(i, j, 1)*(c1*(fd(i, j, 3)+fd(i-1, j, 3))+c2*(fd(i+1, &
&       j, 3)+fd(i-2, j, 3))) + ny(i, j, 1)*(c1*(gd(i, j, 3)+gd(i-1, j, &
&       3))+c2*(gd(i+1, j, 3)+gd(i-2, j, 3)))
      fxrow1d = nx(i, j, 1)*(c1*(fd(i, j, 4)+fd(i-1, j, 4))+c2*(fd(i+1, &
&       j, 4)+fd(i-2, j, 4))) + ny(i, j, 1)*(c1*(gd(i, j, 4)+gd(i-1, j, &
&       4))+c2*(gd(i+1, j, 4)+gd(i-2, j, 4)))
      fxroe1d = nx(i, j, 1)*(c1*(fd(i, j, 5)+fd(i-1, j, 5))+c2*(fd(i+1, &
&       j, 5)+fd(i-2, j, 5))) + ny(i, j, 1)*(c1*(gd(i, j, 5)+gd(i-1, j, &
&       5))+c2*(gd(i+1, j, 5)+gd(i-2, j, 5)))
      fxro2d = nx(i, j, 2)*(c1*(fd(i, j, 1)+fd(i, j-1, 1))+c2*(fd(i, j+1&
&       , 1)+fd(i, j-2, 1))) + ny(i, j, 2)*(c1*(gd(i, j, 1)+gd(i, j-1, 1&
&       ))+c2*(gd(i, j+1, 1)+gd(i, j-2, 1)))
      fxrou2d = nx(i, j, 2)*(c1*(fd(i, j, 2)+fd(i, j-1, 2))+c2*(fd(i, j+&
&       1, 2)+fd(i, j-2, 2))) + ny(i, j, 2)*(c1*(gd(i, j, 2)+gd(i, j-1, &
&       2))+c2*(gd(i, j+1, 2)+gd(i, j-2, 2)))
      fxrov2d = nx(i, j, 2)*(c1*(fd(i, j, 3)+fd(i, j-1, 3))+c2*(fd(i, j+&
&       1, 3)+fd(i, j-2, 3))) + ny(i, j, 2)*(c1*(gd(i, j, 3)+gd(i, j-1, &
&       3))+c2*(gd(i, j+1, 3)+gd(i, j-2, 3)))
      fxrow2d = nx(i, j, 2)*(c1*(fd(i, j, 4)+fd(i, j-1, 4))+c2*(fd(i, j+&
&       1, 4)+fd(i, j-2, 4))) + ny(i, j, 2)*(c1*(gd(i, j, 4)+gd(i, j-1, &
&       4))+c2*(gd(i, j+1, 4)+gd(i, j-2, 4)))
      fxroe2d = nx(i, j, 2)*(c1*(fd(i, j, 5)+fd(i, j-1, 5))+c2*(fd(i, j+&
&       1, 5)+fd(i, j-2, 5))) + ny(i, j, 2)*(c1*(gd(i, j, 5)+gd(i, j-1, &
&       5))+c2*(gd(i, j+1, 5)+gd(i, j-2, 5)))
...
&     , 2)+fd(i-2, j, 2))) + ny(i, j, 1)*(c1*(gd(i, j, 2)+gd(i-1, j, 2))&
&     +c2*(gd(i+1, j, 2)+gd(i-2, j, 2)))
    fxrov1d = nx(i, j, 1)*(c1*(fd(i, j, 3)+fd(i-1, j, 3))+c2*(fd(i+1, j&
&     , 3)+fd(i-2, j, 3))) + ny(i, j, 1)*(c1*(gd(i, j, 3)+gd(i-1, j, 3))&
&     +c2*(gd(i+1, j, 3)+gd(i-2, j, 3)))
    fxrow1d = nx(i, j, 1)*(c1*(fd(i, j, 4)+fd(i-1, j, 4))+c2*(fd(i+1, j&
&     , 4)+fd(i-2, j, 4))) + ny(i, j, 1)*(c1*(gd(i, j, 4)+gd(i-1, j, 4))&
&     +c2*(gd(i+1, j, 4)+gd(i-2, j, 4)))
    fxroe1d = nx(i, j, 1)*(c1*(fd(i, j, 5)+fd(i-1, j, 5))+c2*(fd(i+1, j&
&     , 5)+fd(i-2, j, 5))) + ny(i, j, 1)*(c1*(gd(i, j, 5)+gd(i-1, j, 5))&
&     +c2*(gd(i+1, j, 5)+gd(i-2, j, 5)))
    fxro2d = nx(i, j, 2)*(c3d0*fd(i, 1, 1)+c3d1*fd(i, 2, 1)) + ny(i, j, &
&     2)*(c3d0*gd(i, 1, 1)+c3d1*gd(i, 2, 1))
    fxrou2d = nx(i, j, 2)*(c3d0*fd(i, 1, 2)+c3d1*fd(i, 2, 2)) + ny(i, j&
&     , 2)*(c3d0*gd(i, 1, 2)+c3d1*gd(i, 2, 2))
    fxrov2d = nx(i, j, 2)*(c3d0*fd(i, 1, 3)+c3d1*fd(i, 2, 3)) + ny(i, j&
&     , 2)*(c3d0*gd(i, 1, 3)+c3d1*gd(i, 2, 3))
    fxrow2d = nx(i, j, 2)*(c3d0*fd(i, 1, 4)+c3d1*fd(i, 2, 4)) + ny(i, j&
&     , 2)*(c3d0*gd(i, 1, 4)+c3d1*gd(i, 2, 4))
    fxroe2d = nx(i, j, 2)*(c3d0*fd(i, 1, 5)+c3d1*fd(i, 2, 5)) + ny(i, j&
&     , 2)*(c3d0*gd(i, 1, 5)+c3d1*gd(i, 2, 5))
...
! #include "rhs/spectralradiusRossow_i.F"
!1st direction
    k_sensor1d = (abs8d-abs8*abs20d/abs20)/abs20
    ...
    ELSE
      ...
      abs21 = -x11
    END IF
    k_sensor2d = (abs9d-abs9*abs21d/abs21)/abs21
...
! #include "rhs/spectralradiusRossow_j.F"
! 2nd direction
    k_sensor1d = (abs10d-abs10*abs22d/abs22)/abs22
    ...
    ELSE
      ...
      abs23 = -x13
    END IF
    k_sensor2d = (abs11d-abs11*abs23d/abs23)/abs23
...
! #include "rhs/spectralradiusRossow_i.F"
!1st direction
    k_sensor1d = (abs13d-abs13*abs24d/abs24)/abs24
    ...
    ELSE
      ...
      abs25 = -x15
    END IF
    k_sensor2d = (abs14d-abs14*abs25d/abs25)/abs25
...
&       hnd(i, j, 5, 2) - hnd(i, j+1, 5, 2)
    END DO
  END DO
END SUBROUTINE FLUX_NUM_DNC3_POLAR_2D_D
!
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
