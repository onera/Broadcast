...
!DIR$ IVDEP      
  do i = 1, im
#include "rhs/gradop_11pi.F"
#include "rhs/gradop_11pj.F"
...
!DIR$ IVDEP      
  do i = 1 , im + 1
    !
#include "rhs/euler_o10.F"    
#include "rhs/predictor_11p.F"
...
#include "rhs/coefnearbnd_11p.F"
  
  j = 5
!$AD II-LOOP
!DIR$ IVDEP      
  do i = 1,im+1
#include "rhs/euler_o10_i.F"        
#include "rhs/nearbndfluxes9demi_11p.F"
#include "rhs/predictor_11p.F"
#include "rhs/flux_visqueux_o4.F"
#include "rhs/dissipation_ducros.F" 
#include "rhs/fluxnumassembly_i.F"
...
!DIR$ IVDEP      
  do i = 1,im+1
#include "rhs/euler_o10_i.F"        
#include "rhs/nearbndfluxes7demi_11p.F"
#include "rhs/predictor_11p.F"
#include "rhs/flux_visqueux_o4.F"
#include "rhs/dissipation_ducros.F"                               
#include "rhs/fluxnumassembly_i.F"
...
!DIR$ IVDEP      
  do i = 1,im+1
#include "rhs/euler_o10_i.F"        
#include "rhs/nearbndfluxes5demi_11p.F"
#include "rhs/predictor_11p.F"
#include "rhs/flux_visqueux_o4.F"
#include "rhs/dissipation_ducros.F"                               
#include "rhs/fluxnumassembly_i.F"
...
!DIR$ IVDEP      
  do i = 1,im+1
#include "rhs/euler_o10_i.F"        
#include "rhs/nearbndfluxes3demi_11p.F"
#include "rhs/predictor_11p.F"
