...
!
!  Differentiation of bc_extrapolate_o2_2d in forward (tangent) mode (with options with!SliceDeadControl with!SliceDeadInstrs wit
!h!StaticTaping):
...
!
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
SUBROUTINE BC_EXTRAPOLATE_O2_2D_D(w, wd, loc, interf, im, jm, gh, em)
  IMPLICIT NONE
...
!   write(200,*) loc, 'jmax = ', interf(2,2)
  ...
  DO l=lmin,lmax
    ...
    DO de=1,gh
      ...
      d2 = de - 2
!ordre 2
      wd(i-i0*de, j-j0*de, :) = two*wd(i-i0*d1, j-j0*d1, :) - wd(i-i0*d2&
&       , j-j0*d2, :)
    END DO
  END DO
END SUBROUTINE BC_EXTRAPOLATE_O2_2D_D
