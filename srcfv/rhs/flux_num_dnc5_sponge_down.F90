...
! =============================================================================
!
subroutine flux_num_dnc5_sponge_down_2d(residu,w,x0,y0,nx,ny,xc,yc,vol,volf,gh,cp,cv,prandtl,&
                            gam,rgaz,cs,muref,tref,s_suth,k2,k4,im,jm, Lmax, r2, r3, r4, sourcear)
  !
  implicit none
  ...
  real(8),intent(in) :: Lmax, r4, r2, r3
  ! Returned objects ------------------------------------------------
  ...
  real(8),dimension(5)    :: wmoy, source
  integer :: i,j,h
...
#include "rhs/relaxation_gaussian_down.F" 
...
end subroutine flux_num_dnc5_sponge_down_2d
!
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
