...
!
!  Differentiation of flux_num_dnc9_nowall_polar_2d_d in forward (tangent) mode (with options with!SliceDeadControl with!SliceDea
...
!  Tapenade 3.16 (master) -  9 Oct 2020 17:47
!
!  Differentiation of flux_num_dnc9_nowall_polar_2d in forward (tangent) mode (with options with!SliceDeadControl with!SliceDeadI
...
! =============================================================================
!
SUBROUTINE FLUX_NUM_DNC9_NOWALL_POLAR_2D_D_D(residu, residud, residudd, &
& w, wd0, wd, ym, x0, y0, nx, ny, xc, yc, vol, volf, gh, cp, cv, prandtl&
...
!1st direction
      temp3 = abs2*abs7d/abs7
      temp2 = (abs2d-temp3)/abs7
      k_sensor1dd = (abs2dd-(abs7d*abs2d0+abs2*abs7dd-temp3*abs7d0)/abs7&
&       -temp2*abs7d0)/abs7
      k_sensor1d = temp2
      k_sensor1d0 = (abs2d0-abs2*abs7d0/abs7)/abs7
      k_sensor1 = abs2/abs7
      ...
      ELSE
        ...
        abs8 = -x4
      END IF
      temp3 = abs3*abs8d/abs8
      temp2 = (abs3d-temp3)/abs8
      k_sensor2dd = (abs3dd-(abs8d*abs3d0+abs3*abs8dd-temp3*abs8d0)/abs8&
&       -temp2*abs8d0)/abs8
      k_sensor2d = temp2
      k_sensor2d0 = (abs3d0-abs3*abs8d0/abs8)/abs8
      k_sensor2 = abs3/abs8
...
! 2nd direction
      temp3 = abs4*abs9d/abs9
      temp2 = (abs4d-temp3)/abs9
      k_sensor1dd = (abs4dd-(abs9d*abs4d0+abs4*abs9dd-temp3*abs9d0)/abs9&
&       -temp2*abs9d0)/abs9
      k_sensor1d = temp2
      k_sensor1d0 = (abs4d0-abs4*abs9d0/abs9)/abs9
      k_sensor1 = abs4/abs9
      ...
      ELSE
        ...
        abs10 = -x6
      END IF
      temp3 = abs5*abs10d/abs10
      temp2 = (abs5d-temp3)/abs10
      k_sensor2dd = (abs5dd-(abs10d*abs5d0+abs5*abs10dd-temp3*abs10d0)/&
&       abs10-temp2*abs10d0)/abs10
      k_sensor2d = temp2
      k_sensor2d0 = (abs5d0-abs5*abs10d0/abs10)/abs10
      k_sensor2 = abs5/abs10
...
&       + hndd(i, j, 5, 2) - hndd(i, j+1, 5, 2)
    END DO
  END DO
END SUBROUTINE FLUX_NUM_DNC9_NOWALL_POLAR_2D_D_D
!
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
