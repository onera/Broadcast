...
#include "dz_axi/function_9p_dz_d.f90"

subroutine coeffs_9p_dz(dz_out, &
...
& rgaz, cs, muref, tref, s_suth, im, jm)
  ...
  REAL*8, DIMENSION(1-gh:im+gh, 1-gh:jm+gh, 5) :: func4
  REAL*8, DIMENSION(1-gh:im+gh, 1-gh:jm+gh, 5) :: func4d
  REAL*8, DIMENSION(1-gh:im+gh, 1-gh:jm+gh, 5) :: func5
  REAL*8, DIMENSION(1-gh:im+gh, 1-gh:jm+gh, 5) :: func5d
  REAL*8, DIMENSION(1-gh:im+gh, 1-gh:jm+gh, 5) :: func6
  REAL*8, DIMENSION(1-gh:im+gh, 1-gh:jm+gh, 5) :: func6d
  REAL*8, DIMENSION(1-gh:im+gh, 1-gh:jm+gh, 5) :: func7
  REAL*8, DIMENSION(1-gh:im+gh, 1-gh:jm+gh, 5) :: func7d
  REAL*8, DIMENSION(1-gh:im+gh, 1-gh:jm+gh, 5) :: func8
  REAL*8, DIMENSION(1-gh:im+gh, 1-gh:jm+gh, 5) :: func8d
  REAL*8, DIMENSION(1-gh:im+gh, 1-gh:jm+gh, 5) :: func9
  REAL*8, DIMENSION(1-gh:im+gh, 1-gh:jm+gh, 5) :: func9d
  REAL*8, DIMENSION(1-gh:im+gh, 1-gh:jm+gh, 5) :: func10
  REAL*8, DIMENSION(1-gh:im+gh, 1-gh:jm+gh, 5) :: func10d
  REAL*8, DIMENSION(1-gh:im+gh, 1-gh:jm+gh, 5) :: func11
  REAL*8, DIMENSION(1-gh:im+gh, 1-gh:jm+gh, 5) :: func11d
  REAL*8, DIMENSION(1-gh:im+gh, 1-gh:jm+gh, 5) :: func12
  REAL*8, DIMENSION(1-gh:im+gh, 1-gh:jm+gh, 5) :: func12d
  REAL*8, DIMENSION(1-gh:im+gh, 1-gh:jm+gh, 5) :: func13
  REAL*8, DIMENSION(1-gh:im+gh, 1-gh:jm+gh, 5) :: func13d
  REAL*8, DIMENSION(1-gh:im+gh, 1-gh:jm+gh, 5) :: func14
  REAL*8, DIMENSION(1-gh:im+gh, 1-gh:jm+gh, 5) :: func14d
  REAL*8, DIMENSION(1-gh:im+gh, 1-gh:jm+gh, 5) :: func15
  REAL*8, DIMENSION(1-gh:im+gh, 1-gh:jm+gh, 5) :: func15d
  real(8),dimension(1-gh:im+gh+1,1-gh:jm+gh+1, 5, 16) :: coeffs
...
!DIR$ IVDEP      
  do i = 1 , im 
    !
#include "dz_axi/sum_coeffs_dz.F"
    !
  enddo
  enddo
