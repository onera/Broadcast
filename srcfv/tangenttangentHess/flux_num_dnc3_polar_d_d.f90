...
!
!  Differentiation of flux_num_dnc3_polar_2d_d in forward (tangent) mode (with options with!SliceDeadControl with!SliceDeadInstrs
! with!StaticTaping):
...
!  Tapenade 3.16 (master) -  9 Oct 2020 17:47
!
!  Differentiation of flux_num_dnc3_polar_2d in forward (tangent) mode (with options with!SliceDeadControl with!SliceDeadInstrs w
!ith!StaticTaping):
...
! =============================================================================
!
SUBROUTINE FLUX_NUM_DNC3_POLAR_2D_D_D(residu, residud, residudd, w, wd0&
...
!DIR$ IVDEP
    DO i=1,im
!idir
      guidd = b1*(velxdd(i+1, j)-velxdd(i-1, j))
      guid = b1*(velxd(i+1, j)-velxd(i-1, j))
      guid0 = b1*(velxd0(i+1, j)-velxd0(i-1, j))
      gui = b1*(velx(i+1, j)-velx(i-1, j))
      gvidd = b1*(velydd(i+1, j)-velydd(i-1, j))
      gvid = b1*(velyd(i+1, j)-velyd(i-1, j))
      gvid0 = b1*(velyd0(i+1, j)-velyd0(i-1, j))
      gvi = b1*(vely(i+1, j)-vely(i-1, j))
      gwidd = b1*(velzdd(i+1, j)-velzdd(i-1, j))
      gwid = b1*(velzd(i+1, j)-velzd(i-1, j))
      gwid0 = b1*(velzd0(i+1, j)-velzd0(i-1, j))
      gwi = b1*(velz(i+1, j)-velz(i-1, j))
      gtidd = b1*(tlocdd(i+1, j)-tlocdd(i-1, j))
      gtid = b1*(tlocd(i+1, j)-tlocd(i-1, j))
      gtid0 = b1*(tlocd0(i+1, j)-tlocd0(i-1, j))
      gti = b1*(tloc(i+1, j)-tloc(i-1, j))
!jdir
      gujdd = b1*(velxdd(i, j+1)-velxdd(i, j-1))
      gujd = b1*(velxd(i, j+1)-velxd(i, j-1))
      gujd0 = b1*(velxd0(i, j+1)-velxd0(i, j-1))
      guj = b1*(velx(i, j+1)-velx(i, j-1))
      gvjdd = b1*(velydd(i, j+1)-velydd(i, j-1))
      gvjd = b1*(velyd(i, j+1)-velyd(i, j-1))
      gvjd0 = b1*(velyd0(i, j+1)-velyd0(i, j-1))
      gvj = b1*(vely(i, j+1)-vely(i, j-1))
      gwjdd = b1*(velzdd(i, j+1)-velzdd(i, j-1))
      gwjd = b1*(velzd(i, j+1)-velzd(i, j-1))
      gwjd0 = b1*(velzd0(i, j+1)-velzd0(i, j-1))
      gwj = b1*(velz(i, j+1)-velz(i, j-1))
      gtjdd = b1*(tlocdd(i, j+1)-tlocdd(i, j-1))
      gtjd = b1*(tlocd(i, j+1)-tlocd(i, j-1))
      gtjd0 = b1*(tlocd0(i, j+1)-tlocd0(i, j-1))
...
&       1, j, 1)+fdd(i-2, j, 1))) + ny(i, j, 1)*(c1*(gdd(i, j, 1)+gdd(i-&
&       1, j, 1))+c2*(gdd(i+1, j, 1)+gdd(i-2, j, 1)))
      fxrou1dd = nx(i, j, 1)*(c1*(fdd(i, j, 2)+fdd(i-1, j, 2))+c2*(fdd(i&
&       +1, j, 2)+fdd(i-2, j, 2))) + ny(i, j, 1)*(c1*(gdd(i, j, 2)+gdd(i&
&       -1, j, 2))+c2*(gdd(i+1, j, 2)+gdd(i-2, j, 2)))
      fxrov1dd = nx(i, j, 1)*(c1*(fdd(i, j, 3)+fdd(i-1, j, 3))+c2*(fdd(i&
&       +1, j, 3)+fdd(i-2, j, 3))) + ny(i, j, 1)*(c1*(gdd(i, j, 3)+gdd(i&
&       -1, j, 3))+c2*(gdd(i+1, j, 3)+gdd(i-2, j, 3)))
      fxrow1dd = nx(i, j, 1)*(c1*(fdd(i, j, 4)+fdd(i-1, j, 4))+c2*(fdd(i&
&       +1, j, 4)+fdd(i-2, j, 4))) + ny(i, j, 1)*(c1*(gdd(i, j, 4)+gdd(i&
&       -1, j, 4))+c2*(gdd(i+1, j, 4)+gdd(i-2, j, 4)))
      fxroe1dd = nx(i, j, 1)*(c1*(fdd(i, j, 5)+fdd(i-1, j, 5))+c2*(fdd(i&
&       +1, j, 5)+fdd(i-2, j, 5))) + ny(i, j, 1)*(c1*(gdd(i, j, 5)+gdd(i&
&       -1, j, 5))+c2*(gdd(i+1, j, 5)+gdd(i-2, j, 5)))
      fxro2dd = nx(i, j, 2)*(c1*(fdd(i, j, 1)+fdd(i, j-1, 1))+c2*(fdd(i&
&       , j+1, 1)+fdd(i, j-2, 1))) + ny(i, j, 2)*(c1*(gdd(i, j, 1)+gdd(i&
&       , j-1, 1))+c2*(gdd(i, j+1, 1)+gdd(i, j-2, 1)))
      fxrou2dd = nx(i, j, 2)*(c1*(fdd(i, j, 2)+fdd(i, j-1, 2))+c2*(fdd(i&
&       , j+1, 2)+fdd(i, j-2, 2))) + ny(i, j, 2)*(c1*(gdd(i, j, 2)+gdd(i&
&       , j-1, 2))+c2*(gdd(i, j+1, 2)+gdd(i, j-2, 2)))
      fxrov2dd = nx(i, j, 2)*(c1*(fdd(i, j, 3)+fdd(i, j-1, 3))+c2*(fdd(i&
&       , j+1, 3)+fdd(i, j-2, 3))) + ny(i, j, 2)*(c1*(gdd(i, j, 3)+gdd(i&
&       , j-1, 3))+c2*(gdd(i, j+1, 3)+gdd(i, j-2, 3)))
      fxrow2dd = nx(i, j, 2)*(c1*(fdd(i, j, 4)+fdd(i, j-1, 4))+c2*(fdd(i&
&       , j+1, 4)+fdd(i, j-2, 4))) + ny(i, j, 2)*(c1*(gdd(i, j, 4)+gdd(i&
&       , j-1, 4))+c2*(gdd(i, j+1, 4)+gdd(i, j-2, 4)))
      fxroe2dd = nx(i, j, 2)*(c1*(fdd(i, j, 5)+fdd(i, j-1, 5))+c2*(fdd(i&
&       , j+1, 5)+fdd(i, j-2, 5))) + ny(i, j, 2)*(c1*(gdd(i, j, 5)+gdd(i&
&       , j-1, 5))+c2*(gdd(i, j+1, 5)+gdd(i, j-2, 5)))
      predro1d = d2*wd(i-2, j, 1) - d1*wd(i-1, j, 1) + d1*wd(i, j, 1) - &
&       d2*wd(i+1, j, 1)
      predro1d0 = d2*wd0(i-2, j, 1) - d1*wd0(i-1, j, 1) + d1*wd0(i, j, 1&
&       ) - d2*wd0(i+1, j, 1)
      predro1 = d2*w(i-2, j, 1) - d1*w(i-1, j, 1) + d1*w(i, j, 1) - d2*w&
&       (i+1, j, 1)
      predrou1d = d2*wd(i-2, j, 2) - d1*wd(i-1, j, 2) + d1*wd(i, j, 2) -&
&       d2*wd(i+1, j, 2)
      predrou1d0 = d2*wd0(i-2, j, 2) - d1*wd0(i-1, j, 2) + d1*wd0(i, j, &
&       2) - d2*wd0(i+1, j, 2)
      predrou1 = d2*w(i-2, j, 2) - d1*w(i-1, j, 2) + d1*w(i, j, 2) - d2*&
&       w(i+1, j, 2)
      predrov1d = d2*wd(i-2, j, 3) - d1*wd(i-1, j, 3) + d1*wd(i, j, 3) -&
&       d2*wd(i+1, j, 3)
      predrov1d0 = d2*wd0(i-2, j, 3) - d1*wd0(i-1, j, 3) + d1*wd0(i, j, &
&       3) - d2*wd0(i+1, j, 3)
      predrov1 = d2*w(i-2, j, 3) - d1*w(i-1, j, 3) + d1*w(i, j, 3) - d2*&
&       w(i+1, j, 3)
      predrow1d = d2*wd(i-2, j, 4) - d1*wd(i-1, j, 4) + d1*wd(i, j, 4) -&
&       d2*wd(i+1, j, 4)
      predrow1d0 = d2*wd0(i-2, j, 4) - d1*wd0(i-1, j, 4) + d1*wd0(i, j, &
&       4) - d2*wd0(i+1, j, 4)
      predrow1 = d2*w(i-2, j, 4) - d1*w(i-1, j, 4) + d1*w(i, j, 4) - d2*&
&       w(i+1, j, 4)
      predroe1d = d2*wd(i-2, j, 5) - d1*wd(i-1, j, 5) + d1*wd(i, j, 5) -&
&       d2*wd(i+1, j, 5)
      predroe1d0 = d2*wd0(i-2, j, 5) - d1*wd0(i-1, j, 5) + d1*wd0(i, j, &
&       5) - d2*wd0(i+1, j, 5)
      predroe1 = d2*w(i-2, j, 5) - d1*w(i-1, j, 5) + d1*w(i, j, 5) - d2*&
&       w(i+1, j, 5)
      predro2d = d2*wd(i, j-2, 1) - d1*wd(i, j-1, 1) + d1*wd(i, j, 1) - &
&       d2*wd(i, j+1, 1)
      predro2d0 = d2*wd0(i, j-2, 1) - d1*wd0(i, j-1, 1) + d1*wd0(i, j, 1&
&       ) - d2*wd0(i, j+1, 1)
      predro2 = d2*w(i, j-2, 1) - d1*w(i, j-1, 1) + d1*w(i, j, 1) - d2*w&
&       (i, j+1, 1)
      predrou2d = d2*wd(i, j-2, 2) - d1*wd(i, j-1, 2) + d1*wd(i, j, 2) -&
&       d2*wd(i, j+1, 2)
      predrou2d0 = d2*wd0(i, j-2, 2) - d1*wd0(i, j-1, 2) + d1*wd0(i, j, &
&       2) - d2*wd0(i, j+1, 2)
      predrou2 = d2*w(i, j-2, 2) - d1*w(i, j-1, 2) + d1*w(i, j, 2) - d2*&
&       w(i, j+1, 2)
      predrov2d = d2*wd(i, j-2, 3) - d1*wd(i, j-1, 3) + d1*wd(i, j, 3) -&
&       d2*wd(i, j+1, 3)
      predrov2d0 = d2*wd0(i, j-2, 3) - d1*wd0(i, j-1, 3) + d1*wd0(i, j, &
&       3) - d2*wd0(i, j+1, 3)
      predrov2 = d2*w(i, j-2, 3) - d1*w(i, j-1, 3) + d1*w(i, j, 3) - d2*&
&       w(i, j+1, 3)
      predrow2d = d2*wd(i, j-2, 4) - d1*wd(i, j-1, 4) + d1*wd(i, j, 4) -&
&       d2*wd(i, j+1, 4)
      predrow2d0 = d2*wd0(i, j-2, 4) - d1*wd0(i, j-1, 4) + d1*wd0(i, j, &
&       4) - d2*wd0(i, j+1, 4)
      predrow2 = d2*w(i, j-2, 4) - d1*w(i, j-1, 4) + d1*w(i, j, 4) - d2*&
&       w(i, j+1, 4)
      predroe2d = d2*wd(i, j-2, 5) - d1*wd(i, j-1, 5) + d1*wd(i, j, 5) -&
&       d2*wd(i, j+1, 5)
      predroe2d0 = d2*wd0(i, j-2, 5) - d1*wd0(i, j-1, 5) + d1*wd0(i, j, &
&       5) - d2*wd0(i, j+1, 5)
...
!
      ...
      val_s = velx(i-1, j)
      val_edd = fourth*(velxdd(i, j)+velxdd(i, j-1)+velxdd(i-1, j)+&
&       velxdd(i-1, j-1))
      val_ed = fourth*(velxd(i, j)+velxd(i, j-1)+velxd(i-1, j)+velxd(i-1&
&       , j-1))
      val_ed0 = fourth*(velxd0(i, j)+velxd0(i, j-1)+velxd0(i-1, j)+&
&       velxd0(i-1, j-1))
      val_e = fourth*(velx(i, j)+velx(i, j-1)+velx(i-1, j)+velx(i-1, j-1&
&       ))
      val_odd = fourth*(velxdd(i, j)+velxdd(i, j+1)+velxdd(i-1, j)+&
&       velxdd(i-1, j+1))
      val_od = fourth*(velxd(i, j)+velxd(i, j+1)+velxd(i-1, j)+velxd(i-1&
&       , j+1))
      val_od0 = fourth*(velxd0(i, j)+velxd0(i, j+1)+velxd0(i-1, j)+&
&       velxd0(i-1, j+1))
...
&       ))
      ...
      val_s = vely(i-1, j)
      val_edd = fourth*(velydd(i, j)+velydd(i, j-1)+velydd(i-1, j)+&
&       velydd(i-1, j-1))
      val_ed = fourth*(velyd(i, j)+velyd(i, j-1)+velyd(i-1, j)+velyd(i-1&
&       , j-1))
      val_ed0 = fourth*(velyd0(i, j)+velyd0(i, j-1)+velyd0(i-1, j)+&
&       velyd0(i-1, j-1))
      val_e = fourth*(vely(i, j)+vely(i, j-1)+vely(i-1, j)+vely(i-1, j-1&
&       ))
      val_odd = fourth*(velydd(i, j)+velydd(i, j+1)+velydd(i-1, j)+&
&       velydd(i-1, j+1))
      val_od = fourth*(velyd(i, j)+velyd(i, j+1)+velyd(i-1, j)+velyd(i-1&
&       , j+1))
      val_od0 = fourth*(velyd0(i, j)+velyd0(i, j+1)+velyd0(i-1, j)+&
&       velyd0(i-1, j+1))
...
&       ))
      ...
      val_s = velz(i-1, j)
      val_edd = fourth*(velzdd(i, j)+velzdd(i, j-1)+velzdd(i-1, j)+&
&       velzdd(i-1, j-1))
      val_ed = fourth*(velzd(i, j)+velzd(i, j-1)+velzd(i-1, j)+velzd(i-1&
&       , j-1))
      val_ed0 = fourth*(velzd0(i, j)+velzd0(i, j-1)+velzd0(i-1, j)+&
&       velzd0(i-1, j-1))
      val_e = fourth*(velz(i, j)+velz(i, j-1)+velz(i-1, j)+velz(i-1, j-1&
&       ))
      val_odd = fourth*(velzdd(i, j)+velzdd(i, j+1)+velzdd(i-1, j)+&
&       velzdd(i-1, j+1))
      val_od = fourth*(velzd(i, j)+velzd(i, j+1)+velzd(i-1, j)+velzd(i-1&
&       , j+1))
      val_od0 = fourth*(velzd0(i, j)+velzd0(i, j+1)+velzd0(i-1, j)+&
&       velzd0(i-1, j+1))
...
&       ))
      ...
      val_s = tloc(i-1, j)
      val_edd = fourth*(tlocdd(i, j)+tlocdd(i, j-1)+tlocdd(i-1, j)+&
&       tlocdd(i-1, j-1))
      val_ed = fourth*(tlocd(i, j)+tlocd(i, j-1)+tlocd(i-1, j)+tlocd(i-1&
&       , j-1))
      val_ed0 = fourth*(tlocd0(i, j)+tlocd0(i, j-1)+tlocd0(i-1, j)+&
&       tlocd0(i-1, j-1))
      val_e = fourth*(tloc(i, j)+tloc(i, j-1)+tloc(i-1, j)+tloc(i-1, j-1&
&       ))
      val_odd = fourth*(tlocdd(i, j)+tlocdd(i, j+1)+tlocdd(i-1, j)+&
&       tlocdd(i-1, j+1))
      val_od = fourth*(tlocd(i, j)+tlocd(i, j+1)+tlocd(i-1, j)+tlocd(i-1&
&       , j+1))
      val_od0 = fourth*(tlocd0(i, j)+tlocd0(i, j+1)+tlocd0(i-1, j)+&
&       tlocd0(i-1, j+1))
...
!
      ...
      val_ndd = fourth*(velxdd(i, j)+velxdd(i+1, j)+velxdd(i, j-1)+&
&       velxdd(i+1, j-1))
      val_nd = fourth*(velxd(i, j)+velxd(i+1, j)+velxd(i, j-1)+velxd(i+1&
&       , j-1))
      val_nd0 = fourth*(velxd0(i, j)+velxd0(i+1, j)+velxd0(i, j-1)+&
&       velxd0(i+1, j-1))
      val_n = fourth*(velx(i, j)+velx(i+1, j)+velx(i, j-1)+velx(i+1, j-1&
&       ))
      val_sdd = fourth*(velxdd(i, j)+velxdd(i-1, j)+velxdd(i, j-1)+&
&       velxdd(i-1, j-1))
      val_sd = fourth*(velxd(i, j)+velxd(i-1, j)+velxd(i, j-1)+velxd(i-1&
&       , j-1))
      val_sd0 = fourth*(velxd0(i, j)+velxd0(i-1, j)+velxd0(i, j-1)+&
&       velxd0(i-1, j-1))
...
&       ))
      ...
      uyd0 = volm1*(ny_n*val_nd0+ny_s*val_sd0+ny_o*val_od0+ny_e*val_ed0)
      uy = (val_n*ny_n+val_s*ny_s+val_o*ny_o+val_e*ny_e)*volm1
      val_ndd = fourth*(velydd(i, j)+velydd(i+1, j)+velydd(i, j-1)+&
&       velydd(i+1, j-1))
      val_nd = fourth*(velyd(i, j)+velyd(i+1, j)+velyd(i, j-1)+velyd(i+1&
&       , j-1))
      val_nd0 = fourth*(velyd0(i, j)+velyd0(i+1, j)+velyd0(i, j-1)+&
&       velyd0(i+1, j-1))
      val_n = fourth*(vely(i, j)+vely(i+1, j)+vely(i, j-1)+vely(i+1, j-1&
&       ))
      val_sdd = fourth*(velydd(i, j)+velydd(i-1, j)+velydd(i, j-1)+&
&       velydd(i-1, j-1))
      val_sd = fourth*(velyd(i, j)+velyd(i-1, j)+velyd(i, j-1)+velyd(i-1&
&       , j-1))
      val_sd0 = fourth*(velyd0(i, j)+velyd0(i-1, j)+velyd0(i, j-1)+&
&       velyd0(i-1, j-1))
...
&       ))
      ...
      vyd0 = volm1*(ny_n*val_nd0+ny_s*val_sd0+ny_o*val_od0+ny_e*val_ed0)
      vy = (val_n*ny_n+val_s*ny_s+val_o*ny_o+val_e*ny_e)*volm1
      val_ndd = fourth*(velzdd(i, j)+velzdd(i+1, j)+velzdd(i, j-1)+&
&       velzdd(i+1, j-1))
      val_nd = fourth*(velzd(i, j)+velzd(i+1, j)+velzd(i, j-1)+velzd(i+1&
&       , j-1))
      val_nd0 = fourth*(velzd0(i, j)+velzd0(i+1, j)+velzd0(i, j-1)+&
&       velzd0(i+1, j-1))
      val_n = fourth*(velz(i, j)+velz(i+1, j)+velz(i, j-1)+velz(i+1, j-1&
&       ))
      val_sdd = fourth*(velzdd(i, j)+velzdd(i-1, j)+velzdd(i, j-1)+&
&       velzdd(i-1, j-1))
      val_sd = fourth*(velzd(i, j)+velzd(i-1, j)+velzd(i, j-1)+velzd(i-1&
&       , j-1))
      val_sd0 = fourth*(velzd0(i, j)+velzd0(i-1, j)+velzd0(i, j-1)+&
&       velzd0(i-1, j-1))
...
&       ))
      ...
      wyd0 = volm1*(ny_n*val_nd0+ny_s*val_sd0+ny_o*val_od0+ny_e*val_ed0)
      wy = (val_n*ny_n+val_s*ny_s+val_o*ny_o+val_e*ny_e)*volm1
      val_ndd = fourth*(tlocdd(i, j)+tlocdd(i+1, j)+tlocdd(i, j-1)+&
&       tlocdd(i+1, j-1))
      val_nd = fourth*(tlocd(i, j)+tlocd(i+1, j)+tlocd(i, j-1)+tlocd(i+1&
&       , j-1))
      val_nd0 = fourth*(tlocd0(i, j)+tlocd0(i+1, j)+tlocd0(i, j-1)+&
&       tlocd0(i+1, j-1))
      val_n = fourth*(tloc(i, j)+tloc(i+1, j)+tloc(i, j-1)+tloc(i+1, j-1&
&       ))
      val_sdd = fourth*(tlocdd(i, j)+tlocdd(i-1, j)+tlocdd(i, j-1)+&
&       tlocdd(i-1, j-1))
      val_sd = fourth*(tlocd(i, j)+tlocd(i-1, j)+tlocd(i, j-1)+tlocd(i-1&
&       , j-1))
      val_sd0 = fourth*(tlocd0(i, j)+tlocd0(i-1, j)+tlocd0(i, j-1)+&
&       tlocd0(i-1, j-1))
...
!
      ...
      ELSE
        ...
        abs0 = -(p(i-1, j)-two*p(i, j)+p(i+1, j))
      END IF
      x6dd = pdd(i-1, j) + two*pdd(i, j) + pdd(i+1, j)
      x6d = pd(i-1, j) + two*pd(i, j) + pd(i+1, j)
      x6d0 = pd0(i-1, j) + two*pd0(i, j) + pd0(i+1, j)
...
!
!1st direction
      temp3 = abs0*abs10d/abs10
      temp2 = (abs0d-temp3)/abs10
      k_sensor1dd = (abs0dd-(abs10d*abs0d0+abs0*abs10dd-temp3*abs10d0)/&
&       abs10-temp2*abs10d0)/abs10
      k_sensor1d = temp2
      k_sensor1d0 = (abs0d0-abs0*abs10d0/abs10)/abs10
      ...
      ELSE
        ...
        abs1 = -(p(i-2, j)-two*p(i-1, j)+p(i, j))
      END IF
      x7dd = pdd(i-2, j) + two*pdd(i-1, j) + pdd(i, j)
      x7d = pd(i-2, j) + two*pd(i-1, j) + pd(i, j)
      x7d0 = pd0(i-2, j) + two*pd0(i-1, j) + pd0(i, j)
      ...
      ELSE
        ...
        abs11 = -x7
      END IF
      temp3 = abs1*abs11d/abs11
      temp2 = (abs1d-temp3)/abs11
      k_sensor2dd = (abs1dd-(abs11d*abs1d0+abs1*abs11dd-temp3*abs11d0)/&
&       abs11-temp2*abs11d0)/abs11
      k_sensor2d = temp2
      k_sensor2d0 = (abs1d0-abs1*abs11d0/abs11)/abs11
...
!                 k_sensor2*ducros2*dxm2)
      temp3 = max6*max1d + max1*max6d
      coefdd = temp3*max11d0 + max11*(max1d*max6d0+max6*max1dd+max6d*&
&       max1d0+max1*max6dd) + max11d*(max6*max1d0+max1*max6d0) + max1*&
&       max6*max11dd
      coefd = max11*temp3 + max1*max6*max11d
      coefd0 = max11*(max6*max1d0+max1*max6d0) + max1*max6*max11d0
      coef = max1*max6*max11
...
!
      ...
      ELSE
        ...
        abs2 = -(p(i, j-1)-two*p(i, j)+p(i, j+1))
      END IF
      x8dd = pdd(i, j-1) + two*pdd(i, j) + pdd(i, j+1)
      x8d = pd(i, j-1) + two*pd(i, j) + pd(i, j+1)
      x8d0 = pd0(i, j-1) + two*pd0(i, j) + pd0(i, j+1)
...
!
! 2nd direction
      temp3 = abs2*abs12d/abs12
      temp2 = (abs2d-temp3)/abs12
      k_sensor1dd = (abs2dd-(abs12d*abs2d0+abs2*abs12dd-temp3*abs12d0)/&
&       abs12-temp2*abs12d0)/abs12
      k_sensor1d = temp2
      k_sensor1d0 = (abs2d0-abs2*abs12d0/abs12)/abs12
      ...
      ELSE
        ...
        abs3 = -(p(i, j-2)-two*p(i, j-1)+p(i, j))
      END IF
      x9dd = pdd(i, j-2) + two*pdd(i, j-1) + pdd(i, j)
      x9d = pd(i, j-2) + two*pd(i, j-1) + pd(i, j)
      x9d0 = pd0(i, j-2) + two*pd0(i, j-1) + pd0(i, j)
      ...
      ELSE
        ...
        abs13 = -x9
      END IF
      temp3 = abs3*abs13d/abs13
      temp2 = (abs3d-temp3)/abs13
      k_sensor2dd = (abs3dd-(abs13d*abs3d0+abs3*abs13dd-temp3*abs13d0)/&
&       abs13-temp2*abs13d0)/abs13
      k_sensor2d = temp2
      k_sensor2d0 = (abs3d0-abs3*abs13d0/abs13)/abs13
...
!coef      = MAX( k_sensor1*ducros1*dxm1, &
!                 k_sensor2*ducros2*dxm2)
      temp3 = max7*max2d + max2*max7d
      coefdd = temp3*max12d0 + max12*(max2d*max7d0+max7*max2dd+max7d*&
&       max2d0+max2*max7dd) + max12d*(max7*max2d0+max2*max7d0) + max2*&
&       max7*max12dd
      coefd = max12*temp3 + max2*max7*max12d
      coefd0 = max12*(max7*max2d0+max2*max7d0) + max2*max7*max12d0
      coef = max2*max7*max12
! extension of shock capturing
...
&     , j, 1)+fdd(i-2, j, 1))) + ny(i, j, 1)*(c1*(gdd(i, j, 1)+gdd(i-1, &
&     j, 1))+c2*(gdd(i+1, j, 1)+gdd(i-2, j, 1)))
    fxrou1dd = nx(i, j, 1)*(c1*(fdd(i, j, 2)+fdd(i-1, j, 2))+c2*(fdd(i+1&
&     , j, 2)+fdd(i-2, j, 2))) + ny(i, j, 1)*(c1*(gdd(i, j, 2)+gdd(i-1, &
&     j, 2))+c2*(gdd(i+1, j, 2)+gdd(i-2, j, 2)))
    fxrov1dd = nx(i, j, 1)*(c1*(fdd(i, j, 3)+fdd(i-1, j, 3))+c2*(fdd(i+1&
&     , j, 3)+fdd(i-2, j, 3))) + ny(i, j, 1)*(c1*(gdd(i, j, 3)+gdd(i-1, &
&     j, 3))+c2*(gdd(i+1, j, 3)+gdd(i-2, j, 3)))
    fxrow1dd = nx(i, j, 1)*(c1*(fdd(i, j, 4)+fdd(i-1, j, 4))+c2*(fdd(i+1&
&     , j, 4)+fdd(i-2, j, 4))) + ny(i, j, 1)*(c1*(gdd(i, j, 4)+gdd(i-1, &
&     j, 4))+c2*(gdd(i+1, j, 4)+gdd(i-2, j, 4)))
    fxroe1dd = nx(i, j, 1)*(c1*(fdd(i, j, 5)+fdd(i-1, j, 5))+c2*(fdd(i+1&
&     , j, 5)+fdd(i-2, j, 5))) + ny(i, j, 1)*(c1*(gdd(i, j, 5)+gdd(i-1, &
&     j, 5))+c2*(gdd(i+1, j, 5)+gdd(i-2, j, 5)))
    fxro2dd = nx(i, j, 2)*(c3d0*fdd(i, 1, 1)+c3d1*fdd(i, 2, 1)) + ny(i, &
&     j, 2)*(c3d0*gdd(i, 1, 1)+c3d1*gdd(i, 2, 1))
    fxrou2dd = nx(i, j, 2)*(c3d0*fdd(i, 1, 2)+c3d1*fdd(i, 2, 2)) + ny(i&
&     , j, 2)*(c3d0*gdd(i, 1, 2)+c3d1*gdd(i, 2, 2))
    fxrov2dd = nx(i, j, 2)*(c3d0*fdd(i, 1, 3)+c3d1*fdd(i, 2, 3)) + ny(i&
&     , j, 2)*(c3d0*gdd(i, 1, 3)+c3d1*gdd(i, 2, 3))
    fxrow2dd = nx(i, j, 2)*(c3d0*fdd(i, 1, 4)+c3d1*fdd(i, 2, 4)) + ny(i&
&     , j, 2)*(c3d0*gdd(i, 1, 4)+c3d1*gdd(i, 2, 4))
    fxroe2dd = nx(i, j, 2)*(c3d0*fdd(i, 1, 5)+c3d1*fdd(i, 2, 5)) + ny(i&
&     , j, 2)*(c3d0*gdd(i, 1, 5)+c3d1*gdd(i, 2, 5))
    predro1d = d2*wd(i-2, j, 1) - d1*wd(i-1, j, 1) + d1*wd(i, j, 1) - d2&
&     *wd(i+1, j, 1)
    predro1d0 = d2*wd0(i-2, j, 1) - d1*wd0(i-1, j, 1) + d1*wd0(i, j, 1) &
&     - d2*wd0(i+1, j, 1)
...
&     +1, j, 1)
    predrou1d = d2*wd(i-2, j, 2) - d1*wd(i-1, j, 2) + d1*wd(i, j, 2) - &
&     d2*wd(i+1, j, 2)
    predrou1d0 = d2*wd0(i-2, j, 2) - d1*wd0(i-1, j, 2) + d1*wd0(i, j, 2)&
&     - d2*wd0(i+1, j, 2)
    predrou1 = d2*w(i-2, j, 2) - d1*w(i-1, j, 2) + d1*w(i, j, 2) - d2*w(&
&     i+1, j, 2)
    predrov1d = d2*wd(i-2, j, 3) - d1*wd(i-1, j, 3) + d1*wd(i, j, 3) - &
&     d2*wd(i+1, j, 3)
    predrov1d0 = d2*wd0(i-2, j, 3) - d1*wd0(i-1, j, 3) + d1*wd0(i, j, 3)&
&     - d2*wd0(i+1, j, 3)
    predrov1 = d2*w(i-2, j, 3) - d1*w(i-1, j, 3) + d1*w(i, j, 3) - d2*w(&
&     i+1, j, 3)
    predrow1d = d2*wd(i-2, j, 4) - d1*wd(i-1, j, 4) + d1*wd(i, j, 4) - &
&     d2*wd(i+1, j, 4)
    predrow1d0 = d2*wd0(i-2, j, 4) - d1*wd0(i-1, j, 4) + d1*wd0(i, j, 4)&
&     - d2*wd0(i+1, j, 4)
    predrow1 = d2*w(i-2, j, 4) - d1*w(i-1, j, 4) + d1*w(i, j, 4) - d2*w(&
&     i+1, j, 4)
    predroe1d = d2*wd(i-2, j, 5) - d1*wd(i-1, j, 5) + d1*wd(i, j, 5) - &
&     d2*wd(i+1, j, 5)
    predroe1d0 = d2*wd0(i-2, j, 5) - d1*wd0(i-1, j, 5) + d1*wd0(i, j, 5)&
&     - d2*wd0(i+1, j, 5)
    predroe1 = d2*w(i-2, j, 5) - d1*w(i-1, j, 5) + d1*w(i, j, 5) - d2*w(&
&     i+1, j, 5)
    predro2d = d2*wd(i, j-2, 1) - d1*wd(i, j-1, 1) + d1*wd(i, j, 1) - d2&
&     *wd(i, j+1, 1)
    predro2d0 = d2*wd0(i, j-2, 1) - d1*wd0(i, j-1, 1) + d1*wd0(i, j, 1) &
&     - d2*wd0(i, j+1, 1)
...
&     , j+1, 1)
    predrou2d = d2*wd(i, j-2, 2) - d1*wd(i, j-1, 2) + d1*wd(i, j, 2) - &
&     d2*wd(i, j+1, 2)
    predrou2d0 = d2*wd0(i, j-2, 2) - d1*wd0(i, j-1, 2) + d1*wd0(i, j, 2)&
&     - d2*wd0(i, j+1, 2)
    predrou2 = d2*w(i, j-2, 2) - d1*w(i, j-1, 2) + d1*w(i, j, 2) - d2*w(&
&     i, j+1, 2)
    predrov2d = d2*wd(i, j-2, 3) - d1*wd(i, j-1, 3) + d1*wd(i, j, 3) - &
&     d2*wd(i, j+1, 3)
    predrov2d0 = d2*wd0(i, j-2, 3) - d1*wd0(i, j-1, 3) + d1*wd0(i, j, 3)&
&     - d2*wd0(i, j+1, 3)
    predrov2 = d2*w(i, j-2, 3) - d1*w(i, j-1, 3) + d1*w(i, j, 3) - d2*w(&
&     i, j+1, 3)
    predrow2d = d2*wd(i, j-2, 4) - d1*wd(i, j-1, 4) + d1*wd(i, j, 4) - &
&     d2*wd(i, j+1, 4)
    predrow2d0 = d2*wd0(i, j-2, 4) - d1*wd0(i, j-1, 4) + d1*wd0(i, j, 4)&
&     - d2*wd0(i, j+1, 4)
    predrow2 = d2*w(i, j-2, 4) - d1*w(i, j-1, 4) + d1*w(i, j, 4) - d2*w(&
&     i, j+1, 4)
    predroe2d = d2*wd(i, j-2, 5) - d1*wd(i, j-1, 5) + d1*wd(i, j, 5) - &
&     d2*wd(i, j+1, 5)
    predroe2d0 = d2*wd0(i, j-2, 5) - d1*wd0(i, j-1, 5) + d1*wd0(i, j, 5)&
&     - d2*wd0(i, j+1, 5)
...
!
!1st direction
    temp3 = abs4*abs14d/abs14
    temp2 = (abs4d-temp3)/abs14
    k_sensor1dd = (abs4dd-(abs14d*abs4d0+abs4*abs14dd-temp3*abs14d0)/&
&     abs14-temp2*abs14d0)/abs14
    k_sensor1d = temp2
    k_sensor1d0 = (abs4d0-abs4*abs14d0/abs14)/abs14
    ...
    ELSE
      ...
      abs15 = -x11
    END IF
    temp3 = abs5*abs15d/abs15
    temp2 = (abs5d-temp3)/abs15
    k_sensor2dd = (abs5dd-(abs15d*abs5d0+abs5*abs15dd-temp3*abs15d0)/&
&     abs15-temp2*abs15d0)/abs15
    k_sensor2d = temp2
    k_sensor2d0 = (abs5d0-abs5*abs15d0/abs15)/abs15
...
!coef      = MAX( k_sensor1*ducros1*dxm1, &
!                 k_sensor2*ducros2*dxm2)
    temp3 = max8*max3d + max3*max8d
    coefdd = temp3*max13d0 + max13*(max3d*max8d0+max8*max3dd+max8d*&
&     max3d0+max3*max8dd) + max13d*(max8*max3d0+max3*max8d0) + max3*max8&
&     *max13dd
    coefd = max13*temp3 + max3*max8*max13d
    coefd0 = max13*(max8*max3d0+max3*max8d0) + max3*max8*max13d0
    coef = max3*max8*max13
!     ! extension of shock capturing
!
!k_sensor1 = ABS(p(i,j) - TWO*p(i+1,j) + p(i+2,j)) / &
!            ABS(p(i,j) + TWO*p(i+1,j) + p(i+2,j))
...
!
! 2nd direction
    temp3 = abs6*abs16d/abs16
    temp2 = (abs6d-temp3)/abs16
    k_sensor1dd = (abs6dd-(abs16d*abs6d0+abs6*abs16dd-temp3*abs16d0)/&
&     abs16-temp2*abs16d0)/abs16
    k_sensor1d = temp2
    k_sensor1d0 = (abs6d0-abs6*abs16d0/abs16)/abs16
    ...
    ELSE
      ...
      abs17 = -x13
    END IF
    temp3 = abs7*abs17d/abs17
    temp2 = (abs7d-temp3)/abs17
    k_sensor2dd = (abs7dd-(abs17d*abs7d0+abs7*abs17dd-temp3*abs17d0)/&
&     abs17-temp2*abs17d0)/abs17
    k_sensor2d = temp2
    k_sensor2d0 = (abs7d0-abs7*abs17d0/abs17)/abs17
...
!coef      = MAX( k_sensor1*ducros1*dxm1, &
!                 k_sensor2*ducros2*dxm2)
    temp3 = max9*max4d + max4*max9d
    coefdd = temp3*max14d0 + max14*(max4d*max9d0+max9*max4dd+max9d*&
&     max4d0+max4*max9dd) + max14d*(max9*max4d0+max4*max9d0) + max4*max9&
&     *max14dd
    coefd = max14*temp3 + max4*max9*max14d
    coefd0 = max14*(max9*max4d0+max4*max9d0) + max4*max9*max14d0
    coef = max4*max9*max14
! extension of shock capturing
!k_sensor1 = ABS(p(i,j) - TWO*p(i,j+1) + p(i,j+2)) / &
!            ABS(p(i,j) + TWO*p(i,j+1) + p(i,j+2))
!
...
!
!1st direction
    temp3 = abs8*abs18d/abs18
    temp2 = (abs8d-temp3)/abs18
    k_sensor1dd = (abs8dd-(abs18d*abs8d0+abs8*abs18dd-temp3*abs18d0)/&
&     abs18-temp2*abs18d0)/abs18
    k_sensor1d = temp2
    k_sensor1d0 = (abs8d0-abs8*abs18d0/abs18)/abs18
    ...
    ELSE
      ...
      abs19 = -x15
    END IF
    temp3 = abs9*abs19d/abs19
    temp2 = (abs9d-temp3)/abs19
    k_sensor2dd = (abs9dd-(abs19d*abs9d0+abs9*abs19dd-temp3*abs19d0)/&
&     abs19-temp2*abs19d0)/abs19
    k_sensor2d = temp2
    k_sensor2d0 = (abs9d0-abs9*abs19d0/abs19)/abs19
...
!coef      = MAX( k_sensor1*ducros1*dxm1, &
!                 k_sensor2*ducros2*dxm2)
    temp3 = max10*max5d + max5*max10d
    coefdd = temp3*max15d0 + max15*(max5d*max10d0+max10*max5dd+max10d*&
&     max5d0+max5*max10dd) + max15d*(max10*max5d0+max5*max10d0) + max5*&
&     max10*max15dd
    coefd = max15*temp3 + max5*max10*max15d
    coefd0 = max15*(max10*max5d0+max5*max10d0) + max5*max10*max15d0
    coef = max5*max10*max15
!     ! extension of shock capturing
!
!k_sensor1 = ABS(p(i,j) - TWO*p(i+1,j) + p(i+2,j)) / &
!            ABS(p(i,j) + TWO*p(i+1,j) + p(i+2,j))
...
&       + hndd(i, j, 5, 2) - hndd(i, j+1, 5, 2)
    END DO
  END DO
END SUBROUTINE FLUX_NUM_DNC3_POLAR_2D_D_D
!
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
