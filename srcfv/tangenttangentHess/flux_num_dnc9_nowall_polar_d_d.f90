...
!                 k_sensor2*ducros2*dxm2)
      temp3 = max3*max1d + max1*max3d
      coefdd = temp3*max5d0 + max5*(max1d*max3d0+max3*max1dd+max3d*&
&       max1d0+max1*max3dd) + max5d*(max3*max1d0+max1*max3d0) + max1*&
&       max3*max5dd
      coefd = max5*temp3 + max1*max3*max5d
      coefd0 = max5*(max3*max1d0+max1*max3d0) + max1*max3*max5d0
      coef = max1*max3*max5
...
!coef      = MAX( k_sensor1*ducros1*dxm1, &
!                 k_sensor2*ducros2*dxm2)
      temp3 = max4*max2d + max2*max4d
      coefdd = temp3*max6d0 + max6*(max2d*max4d0+max4*max2dd+max4d*&
&       max2d0+max2*max4dd) + max6d*(max4*max2d0+max2*max4d0) + max2*&
&       max4*max6dd
      coefd = max6*temp3 + max2*max4*max6d
      coefd0 = max6*(max4*max2d0+max2*max4d0) + max2*max4*max6d0
      coef = max2*max4*max6
! extension of shock capturing
