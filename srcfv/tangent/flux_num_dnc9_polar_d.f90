...
! =============================================================================
!
SUBROUTINE FLUX_NUM_DNC9_POLAR_2D_D(residu, residud, w, wd, ym, x0, y0, &
...
&       , j, 1)+fd(i-4, j, 1))+c5*(fd(i+4, j, 1)+fd(i-5, j, 1))) + ny(i&
&       , j, 1)*(c1*(gd(i, j, 1)+gd(i-1, j, 1))+c2*(gd(i+1, j, 1)+gd(i-2&
&       , j, 1))+c3*(gd(i+2, j, 1)+gd(i-3, j, 1))+c4*(gd(i+3, j, 1)+gd(i&
&       -4, j, 1))+c5*(gd(i+4, j, 1)+gd(i-5, j, 1)))
      fxrou1d = nx(i, j, 1)*(c1*(fd(i, j, 2)+fd(i-1, j, 2))+c2*(fd(i+1, &
&       j, 2)+fd(i-2, j, 2))+c3*(fd(i+2, j, 2)+fd(i-3, j, 2))+c4*(fd(i+3&
&       , j, 2)+fd(i-4, j, 2))+c5*(fd(i+4, j, 2)+fd(i-5, j, 2))) + ny(i&
&       , j, 1)*(c1*(gd(i, j, 2)+gd(i-1, j, 2))+c2*(gd(i+1, j, 2)+gd(i-2&
&       , j, 2))+c3*(gd(i+2, j, 2)+gd(i-3, j, 2))+c4*(gd(i+3, j, 2)+gd(i&
&       -4, j, 2))+c5*(gd(i+4, j, 2)+gd(i-5, j, 2)))
      fxrov1d = nx(i, j, 1)*(c1*(fd(i, j, 3)+fd(i-1, j, 3))+c2*(fd(i+1, &
&       j, 3)+fd(i-2, j, 3))+c3*(fd(i+2, j, 3)+fd(i-3, j, 3))+c4*(fd(i+3&
&       , j, 3)+fd(i-4, j, 3))+c5*(fd(i+4, j, 3)+fd(i-5, j, 3))) + ny(i&
&       , j, 1)*(c1*(gd(i, j, 3)+gd(i-1, j, 3))+c2*(gd(i+1, j, 3)+gd(i-2&
&       , j, 3))+c3*(gd(i+2, j, 3)+gd(i-3, j, 3))+c4*(gd(i+3, j, 3)+gd(i&
&       -4, j, 3))+c5*(gd(i+4, j, 3)+gd(i-5, j, 3)))
      fxrow1d = nx(i, j, 1)*(c1*(fd(i, j, 4)+fd(i-1, j, 4))+c2*(fd(i+1, &
&       j, 4)+fd(i-2, j, 4))+c3*(fd(i+2, j, 4)+fd(i-3, j, 4))+c4*(fd(i+3&
&       , j, 4)+fd(i-4, j, 4))+c5*(fd(i+4, j, 4)+fd(i-5, j, 4))) + ny(i&
&       , j, 1)*(c1*(gd(i, j, 4)+gd(i-1, j, 4))+c2*(gd(i+1, j, 4)+gd(i-2&
&       , j, 4))+c3*(gd(i+2, j, 4)+gd(i-3, j, 4))+c4*(gd(i+3, j, 4)+gd(i&
&       -4, j, 4))+c5*(gd(i+4, j, 4)+gd(i-5, j, 4)))
      fxroe1d = nx(i, j, 1)*(c1*(fd(i, j, 5)+fd(i-1, j, 5))+c2*(fd(i+1, &
&       j, 5)+fd(i-2, j, 5))+c3*(fd(i+2, j, 5)+fd(i-3, j, 5))+c4*(fd(i+3&
&       , j, 5)+fd(i-4, j, 5))+c5*(fd(i+4, j, 5)+fd(i-5, j, 5))) + ny(i&
&       , j, 1)*(c1*(gd(i, j, 5)+gd(i-1, j, 5))+c2*(gd(i+1, j, 5)+gd(i-2&
&       , j, 5))+c3*(gd(i+2, j, 5)+gd(i-3, j, 5))+c4*(gd(i+3, j, 5)+gd(i&
&       -4, j, 5))+c5*(gd(i+4, j, 5)+gd(i-5, j, 5)))
      fxro2d = nx(i, j, 2)*(c1*(fd(i, j, 1)+fd(i, j-1, 1))+c2*(fd(i, j+1&
&       , 1)+fd(i, j-2, 1))+c3*(fd(i, j+2, 1)+fd(i, j-3, 1))+c4*(fd(i, j&
&       +3, 1)+fd(i, j-4, 1))+c5*(fd(i, j+4, 1)+fd(i, j-5, 1))) + ny(i, &
&       j, 2)*(c1*(gd(i, j, 1)+gd(i, j-1, 1))+c2*(gd(i, j+1, 1)+gd(i, j-&
&       2, 1))+c3*(gd(i, j+2, 1)+gd(i, j-3, 1))+c4*(gd(i, j+3, 1)+gd(i, &
&       j-4, 1))+c5*(gd(i, j+4, 1)+gd(i, j-5, 1)))
      fxrou2d = nx(i, j, 2)*(c1*(fd(i, j, 2)+fd(i, j-1, 2))+c2*(fd(i, j+&
&       1, 2)+fd(i, j-2, 2))+c3*(fd(i, j+2, 2)+fd(i, j-3, 2))+c4*(fd(i, &
&       j+3, 2)+fd(i, j-4, 2))+c5*(fd(i, j+4, 2)+fd(i, j-5, 2))) + ny(i&
&       , j, 2)*(c1*(gd(i, j, 2)+gd(i, j-1, 2))+c2*(gd(i, j+1, 2)+gd(i, &
&       j-2, 2))+c3*(gd(i, j+2, 2)+gd(i, j-3, 2))+c4*(gd(i, j+3, 2)+gd(i&
&       , j-4, 2))+c5*(gd(i, j+4, 2)+gd(i, j-5, 2)))
      fxrov2d = nx(i, j, 2)*(c1*(fd(i, j, 3)+fd(i, j-1, 3))+c2*(fd(i, j+&
&       1, 3)+fd(i, j-2, 3))+c3*(fd(i, j+2, 3)+fd(i, j-3, 3))+c4*(fd(i, &
&       j+3, 3)+fd(i, j-4, 3))+c5*(fd(i, j+4, 3)+fd(i, j-5, 3))) + ny(i&
&       , j, 2)*(c1*(gd(i, j, 3)+gd(i, j-1, 3))+c2*(gd(i, j+1, 3)+gd(i, &
&       j-2, 3))+c3*(gd(i, j+2, 3)+gd(i, j-3, 3))+c4*(gd(i, j+3, 3)+gd(i&
&       , j-4, 3))+c5*(gd(i, j+4, 3)+gd(i, j-5, 3)))
      fxrow2d = nx(i, j, 2)*(c1*(fd(i, j, 4)+fd(i, j-1, 4))+c2*(fd(i, j+&
&       1, 4)+fd(i, j-2, 4))+c3*(fd(i, j+2, 4)+fd(i, j-3, 4))+c4*(fd(i, &
&       j+3, 4)+fd(i, j-4, 4))+c5*(fd(i, j+4, 4)+fd(i, j-5, 4))) + ny(i&
&       , j, 2)*(c1*(gd(i, j, 4)+gd(i, j-1, 4))+c2*(gd(i, j+1, 4)+gd(i, &
&       j-2, 4))+c3*(gd(i, j+2, 4)+gd(i, j-3, 4))+c4*(gd(i, j+3, 4)+gd(i&
&       , j-4, 4))+c5*(gd(i, j+4, 4)+gd(i, j-5, 4)))
      fxroe2d = nx(i, j, 2)*(c1*(fd(i, j, 5)+fd(i, j-1, 5))+c2*(fd(i, j+&
&       1, 5)+fd(i, j-2, 5))+c3*(fd(i, j+2, 5)+fd(i, j-3, 5))+c4*(fd(i, &
&       j+3, 5)+fd(i, j-4, 5))+c5*(fd(i, j+4, 5)+fd(i, j-5, 5))) + ny(i&
&       , j, 2)*(c1*(gd(i, j, 5)+gd(i, j-1, 5))+c2*(gd(i, j+1, 5)+gd(i, &
&       j-2, 5))+c3*(gd(i, j+2, 5)+gd(i, j-3, 5))+c4*(gd(i, j+3, 5)+gd(i&
&       , j-4, 5))+c5*(gd(i, j+4, 5)+gd(i, j-5, 5)))
...
!1st direction
      k_sensor1d = (abs2d-abs2*abs34d/abs34)/abs34
      ...
      ELSE
        ...
        abs35 = -x13
      END IF
      k_sensor2d = (abs3d-abs3*abs35d/abs35)/abs35
...
! 2nd direction
      k_sensor1d = (abs4d-abs4*abs36d/abs36)/abs36
      ...
      ELSE
        ...
        abs37 = -x15
      END IF
      k_sensor2d = (abs5d-abs5*abs37d/abs37)/abs37
...
&     1)+fd(i-4, j, 1))+c5*(fd(i+4, j, 1)+fd(i-5, j, 1))) + ny(i, j, 1)*&
&     (c1*(gd(i, j, 1)+gd(i-1, j, 1))+c2*(gd(i+1, j, 1)+gd(i-2, j, 1))+&
&     c3*(gd(i+2, j, 1)+gd(i-3, j, 1))+c4*(gd(i+3, j, 1)+gd(i-4, j, 1))+&
&     c5*(gd(i+4, j, 1)+gd(i-5, j, 1)))
    fxrou1d = nx(i, j, 1)*(c1*(fd(i, j, 2)+fd(i-1, j, 2))+c2*(fd(i+1, j&
&     , 2)+fd(i-2, j, 2))+c3*(fd(i+2, j, 2)+fd(i-3, j, 2))+c4*(fd(i+3, j&
&     , 2)+fd(i-4, j, 2))+c5*(fd(i+4, j, 2)+fd(i-5, j, 2))) + ny(i, j, 1&
&     )*(c1*(gd(i, j, 2)+gd(i-1, j, 2))+c2*(gd(i+1, j, 2)+gd(i-2, j, 2))&
&     +c3*(gd(i+2, j, 2)+gd(i-3, j, 2))+c4*(gd(i+3, j, 2)+gd(i-4, j, 2))&
&     +c5*(gd(i+4, j, 2)+gd(i-5, j, 2)))
    fxrov1d = nx(i, j, 1)*(c1*(fd(i, j, 3)+fd(i-1, j, 3))+c2*(fd(i+1, j&
&     , 3)+fd(i-2, j, 3))+c3*(fd(i+2, j, 3)+fd(i-3, j, 3))+c4*(fd(i+3, j&
&     , 3)+fd(i-4, j, 3))+c5*(fd(i+4, j, 3)+fd(i-5, j, 3))) + ny(i, j, 1&
&     )*(c1*(gd(i, j, 3)+gd(i-1, j, 3))+c2*(gd(i+1, j, 3)+gd(i-2, j, 3))&
&     +c3*(gd(i+2, j, 3)+gd(i-3, j, 3))+c4*(gd(i+3, j, 3)+gd(i-4, j, 3))&
&     +c5*(gd(i+4, j, 3)+gd(i-5, j, 3)))
    fxrow1d = nx(i, j, 1)*(c1*(fd(i, j, 4)+fd(i-1, j, 4))+c2*(fd(i+1, j&
&     , 4)+fd(i-2, j, 4))+c3*(fd(i+2, j, 4)+fd(i-3, j, 4))+c4*(fd(i+3, j&
&     , 4)+fd(i-4, j, 4))+c5*(fd(i+4, j, 4)+fd(i-5, j, 4))) + ny(i, j, 1&
&     )*(c1*(gd(i, j, 4)+gd(i-1, j, 4))+c2*(gd(i+1, j, 4)+gd(i-2, j, 4))&
&     +c3*(gd(i+2, j, 4)+gd(i-3, j, 4))+c4*(gd(i+3, j, 4)+gd(i-4, j, 4))&
&     +c5*(gd(i+4, j, 4)+gd(i-5, j, 4)))
    fxroe1d = nx(i, j, 1)*(c1*(fd(i, j, 5)+fd(i-1, j, 5))+c2*(fd(i+1, j&
&     , 5)+fd(i-2, j, 5))+c3*(fd(i+2, j, 5)+fd(i-3, j, 5))+c4*(fd(i+3, j&
&     , 5)+fd(i-4, j, 5))+c5*(fd(i+4, j, 5)+fd(i-5, j, 5))) + ny(i, j, 1&
&     )*(c1*(gd(i, j, 5)+gd(i-1, j, 5))+c2*(gd(i+1, j, 5)+gd(i-2, j, 5))&
&     +c3*(gd(i+2, j, 5)+gd(i-3, j, 5))+c4*(gd(i+3, j, 5)+gd(i-4, j, 5))&
&     +c5*(gd(i+4, j, 5)+gd(i-5, j, 5)))
    fxro2d = nx(i, j, 2)*(c9d0*fd(i, 1, 1)+c9d1*fd(i, 2, 1)+c9d2*fd(i, 3&
&     , 1)+c9d3*fd(i, 4, 1)+c9d4*fd(i, 5, 1)+c9d5*fd(i, 6, 1)+c9d6*fd(i&
&     , 7, 1)+c9d7*fd(i, 8, 1)+c9d8*fd(i, 9, 1)+c9d9*fd(i, 10, 1)+c9d10*&
&     fd(i, 11, 1)) + ny(i, j, 2)*(c9d0*gd(i, 1, 1)+c9d1*gd(i, 2, 1)+&
&     c9d2*gd(i, 3, 1)+c9d3*gd(i, 4, 1)+c9d4*gd(i, 5, 1)+c9d5*gd(i, 6, 1&
&     )+c9d6*gd(i, 7, 1)+c9d7*gd(i, 8, 1)+c9d8*gd(i, 9, 1)+c9d9*gd(i, 10&
&     , 1)+c9d10*gd(i, 11, 1))
    fxrou2d = nx(i, j, 2)*(c9d0*fd(i, 1, 2)+c9d1*fd(i, 2, 2)+c9d2*fd(i, &
&     3, 2)+c9d3*fd(i, 4, 2)+c9d4*fd(i, 5, 2)+c9d5*fd(i, 6, 2)+c9d6*fd(i&
&     , 7, 2)+c9d7*fd(i, 8, 2)+c9d8*fd(i, 9, 2)+c9d9*fd(i, 10, 2)+c9d10*&
&     fd(i, 11, 2)) + ny(i, j, 2)*(c9d0*gd(i, 1, 2)+c9d1*gd(i, 2, 2)+&
&     c9d2*gd(i, 3, 2)+c9d3*gd(i, 4, 2)+c9d4*gd(i, 5, 2)+c9d5*gd(i, 6, 2&
&     )+c9d6*gd(i, 7, 2)+c9d7*gd(i, 8, 2)+c9d8*gd(i, 9, 2)+c9d9*gd(i, 10&
&     , 2)+c9d10*gd(i, 11, 2))
    fxrov2d = nx(i, j, 2)*(c9d0*fd(i, 1, 3)+c9d1*fd(i, 2, 3)+c9d2*fd(i, &
&     3, 3)+c9d3*fd(i, 4, 3)+c9d4*fd(i, 5, 3)+c9d5*fd(i, 6, 3)+c9d6*fd(i&
&     , 7, 3)+c9d7*fd(i, 8, 3)+c9d8*fd(i, 9, 3)+c9d9*fd(i, 10, 3)+c9d10*&
&     fd(i, 11, 3)) + ny(i, j, 2)*(c9d0*gd(i, 1, 3)+c9d1*gd(i, 2, 3)+&
&     c9d2*gd(i, 3, 3)+c9d3*gd(i, 4, 3)+c9d4*gd(i, 5, 3)+c9d5*gd(i, 6, 3&
&     )+c9d6*gd(i, 7, 3)+c9d7*gd(i, 8, 3)+c9d8*gd(i, 9, 3)+c9d9*gd(i, 10&
&     , 3)+c9d10*gd(i, 11, 3))
    fxrow2d = nx(i, j, 2)*(c9d0*fd(i, 1, 4)+c9d1*fd(i, 2, 4)+c9d2*fd(i, &
&     3, 4)+c9d3*fd(i, 4, 4)+c9d4*fd(i, 5, 4)+c9d5*fd(i, 6, 4)+c9d6*fd(i&
&     , 7, 4)+c9d7*fd(i, 8, 4)+c9d8*fd(i, 9, 4)+c9d9*fd(i, 10, 4)+c9d10*&
&     fd(i, 11, 4)) + ny(i, j, 2)*(c9d0*gd(i, 1, 4)+c9d1*gd(i, 2, 4)+&
&     c9d2*gd(i, 3, 4)+c9d3*gd(i, 4, 4)+c9d4*gd(i, 5, 4)+c9d5*gd(i, 6, 4&
&     )+c9d6*gd(i, 7, 4)+c9d7*gd(i, 8, 4)+c9d8*gd(i, 9, 4)+c9d9*gd(i, 10&
&     , 4)+c9d10*gd(i, 11, 4))
    fxroe2d = nx(i, j, 2)*(c9d0*fd(i, 1, 5)+c9d1*fd(i, 2, 5)+c9d2*fd(i, &
&     3, 5)+c9d3*fd(i, 4, 5)+c9d4*fd(i, 5, 5)+c9d5*fd(i, 6, 5)+c9d6*fd(i&
&     , 7, 5)+c9d7*fd(i, 8, 5)+c9d8*fd(i, 9, 5)+c9d9*fd(i, 10, 5)+c9d10*&
&     fd(i, 11, 5)) + ny(i, j, 2)*(c9d0*gd(i, 1, 5)+c9d1*gd(i, 2, 5)+&
&     c9d2*gd(i, 3, 5)+c9d3*gd(i, 4, 5)+c9d4*gd(i, 5, 5)+c9d5*gd(i, 6, 5&
&     )+c9d6*gd(i, 7, 5)+c9d7*gd(i, 8, 5)+c9d8*gd(i, 9, 5)+c9d9*gd(i, 10&
&     , 5)+c9d10*gd(i, 11, 5))
    predro1d = d4*wd(i-4, j, 1) - d5*wd(i-5, j, 1) - d3*wd(i-3, j, 1) + &
...
!
    ...
    fvrou1d = temp0*mmud + mmu*(two*uxd-twothird*divud)
    fvrou1 = mmu*temp0
    fvrov1d = (uy+vx)*mmud + mmu*(uyd+vxd)
    fvrov1 = mmu*(uy+vx)
    fvrow1d = wx*mmud + mmu*wxd
...
!
    ...
    gvrov1d = temp0*mmud + mmu*(two*vyd-twothird*divud)
    gvrov1 = mmu*temp0
    gvrow1d = (wy-distm1*ww)*mmud + mmu*(wyd-distm1*wwd)
    gvrow1 = mmu*(wy-ww*distm1)
...
!
    temp0 = two*ux - twothird*divu
    fvrou2d = temp0*mmud + mmu*(two*uxd-twothird*divud)
    fvrou2 = mmu*temp0
    fvrov2d = (uy+vx)*mmud + mmu*(uyd+vxd)
    fvrov2 = mmu*(uy+vx)
    fvrow2d = wx*mmud + mmu*wxd
...
!
    ...
    gvrou2 = mmu*(uy+vx)
    temp0 = two*vy - twothird*divu
    gvrov2d = temp0*mmud + mmu*(two*vyd-twothird*divud)
    gvrov2 = mmu*temp0
    gvrow2d = (wy-distm1*ww)*mmud + mmu*(wyd-distm1*wwd)
    gvrow2 = mmu*(wy-ww*distm1)
...
! #include "rhs/spectralradiusRossow_i.F"
!1st direction
    k_sensor1d = (abs8d-abs8*abs38d/abs38)/abs38
    ...
    ELSE
      ...
      abs39 = -x17
    END IF
    k_sensor2d = (abs9d-abs9*abs39d/abs39)/abs39
...
! #include "rhs/spectralradiusRossow_j.F"
! 2nd direction
    k_sensor1d = (abs10d-abs10*abs40d/abs40)/abs40
    ...
    ELSE
      ...
      abs41 = -x19
    END IF
    k_sensor2d = (abs11d-abs11*abs41d/abs41)/abs41
...
&     , 7, 1)+c7d7*fd(i, 8, 1)+c7d8*fd(i, 9, 1)+c7d9*fd(i, 10, 1)+c7d10*&
&     fd(i, 11, 1)) + ny(i, j, 2)*(c7d0*gd(i, 1, 1)+c7d1*gd(i, 2, 1)+&
&     c7d2*gd(i, 3, 1)+c7d3*gd(i, 4, 1)+c7d4*gd(i, 5, 1)+c7d5*gd(i, 6, 1&
&     )+c7d6*gd(i, 7, 1)+c7d7*gd(i, 8, 1)+c7d8*gd(i, 9, 1)+c7d9*gd(i, 10&
&     , 1)+c7d10*gd(i, 11, 1))
    fxrou2d = nx(i, j, 2)*(c7d0*fd(i, 1, 2)+c7d1*fd(i, 2, 2)+c7d2*fd(i, &
&     3, 2)+c7d3*fd(i, 4, 2)+c7d4*fd(i, 5, 2)+c7d5*fd(i, 6, 2)+c7d6*fd(i&
&     , 7, 2)+c7d7*fd(i, 8, 2)+c7d8*fd(i, 9, 2)+c7d9*fd(i, 10, 2)+c7d10*&
&     fd(i, 11, 2)) + ny(i, j, 2)*(c7d0*gd(i, 1, 2)+c7d1*gd(i, 2, 2)+&
&     c7d2*gd(i, 3, 2)+c7d3*gd(i, 4, 2)+c7d4*gd(i, 5, 2)+c7d5*gd(i, 6, 2&
&     )+c7d6*gd(i, 7, 2)+c7d7*gd(i, 8, 2)+c7d8*gd(i, 9, 2)+c7d9*gd(i, 10&
&     , 2)+c7d10*gd(i, 11, 2))
    fxrov2d = nx(i, j, 2)*(c7d0*fd(i, 1, 3)+c7d1*fd(i, 2, 3)+c7d2*fd(i, &
&     3, 3)+c7d3*fd(i, 4, 3)+c7d4*fd(i, 5, 3)+c7d5*fd(i, 6, 3)+c7d6*fd(i&
&     , 7, 3)+c7d7*fd(i, 8, 3)+c7d8*fd(i, 9, 3)+c7d9*fd(i, 10, 3)+c7d10*&
&     fd(i, 11, 3)) + ny(i, j, 2)*(c7d0*gd(i, 1, 3)+c7d1*gd(i, 2, 3)+&
&     c7d2*gd(i, 3, 3)+c7d3*gd(i, 4, 3)+c7d4*gd(i, 5, 3)+c7d5*gd(i, 6, 3&
&     )+c7d6*gd(i, 7, 3)+c7d7*gd(i, 8, 3)+c7d8*gd(i, 9, 3)+c7d9*gd(i, 10&
&     , 3)+c7d10*gd(i, 11, 3))
    fxrow2d = nx(i, j, 2)*(c7d0*fd(i, 1, 4)+c7d1*fd(i, 2, 4)+c7d2*fd(i, &
&     3, 4)+c7d3*fd(i, 4, 4)+c7d4*fd(i, 5, 4)+c7d5*fd(i, 6, 4)+c7d6*fd(i&
&     , 7, 4)+c7d7*fd(i, 8, 4)+c7d8*fd(i, 9, 4)+c7d9*fd(i, 10, 4)+c7d10*&
&     fd(i, 11, 4)) + ny(i, j, 2)*(c7d0*gd(i, 1, 4)+c7d1*gd(i, 2, 4)+&
&     c7d2*gd(i, 3, 4)+c7d3*gd(i, 4, 4)+c7d4*gd(i, 5, 4)+c7d5*gd(i, 6, 4&
&     )+c7d6*gd(i, 7, 4)+c7d7*gd(i, 8, 4)+c7d8*gd(i, 9, 4)+c7d9*gd(i, 10&
&     , 4)+c7d10*gd(i, 11, 4))
    fxroe2d = nx(i, j, 2)*(c7d0*fd(i, 1, 5)+c7d1*fd(i, 2, 5)+c7d2*fd(i, &
&     3, 5)+c7d3*fd(i, 4, 5)+c7d4*fd(i, 5, 5)+c7d5*fd(i, 6, 5)+c7d6*fd(i&
&     , 7, 5)+c7d7*fd(i, 8, 5)+c7d8*fd(i, 9, 5)+c7d9*fd(i, 10, 5)+c7d10*&
&     fd(i, 11, 5)) + ny(i, j, 2)*(c7d0*gd(i, 1, 5)+c7d1*gd(i, 2, 5)+&
&     c7d2*gd(i, 3, 5)+c7d3*gd(i, 4, 5)+c7d4*gd(i, 5, 5)+c7d5*gd(i, 6, 5&
&     )+c7d6*gd(i, 7, 5)+c7d7*gd(i, 8, 5)+c7d8*gd(i, 9, 5)+c7d9*gd(i, 10&
&     , 5)+c7d10*gd(i, 11, 5))
    predro1d = d4*wd(i-4, j, 1) - d5*wd(i-5, j, 1) - d3*wd(i-3, j, 1) + &
&     d2*wd(i-2, j, 1) - d1*wd(i-1, j, 1) + d1*wd(i, j, 1) - d2*wd(i+1, &
&     j, 1) + d3*wd(i+2, j, 1) + d5*wd(i+4, j, 1) - d4*wd(i+3, j, 1)
...
! #include "rhs/spectralradiusRossow_i.F"
!1st direction
    k_sensor1d = (abs14d-abs14*abs42d/abs42)/abs42
    ...
    ELSE
      ...
      abs43 = -x21
    END IF
    k_sensor2d = (abs15d-abs15*abs43d/abs43)/abs43
...
! #include "rhs/spectralradiusRossow_j.F"
! 2nd direction
    k_sensor1d = (abs16d-abs16*abs44d/abs44)/abs44
    ...
    ELSE
      ...
      abs45 = -x23
    END IF
    k_sensor2d = (abs17d-abs17*abs45d/abs45)/abs45
...
&     , 7, 1)+c5d7*fd(i, 8, 1)+c5d8*fd(i, 9, 1)+c5d9*fd(i, 10, 1)+c5d10*&
&     fd(i, 11, 1)) + ny(i, j, 2)*(c5d0*gd(i, 1, 1)+c5d1*gd(i, 2, 1)+&
&     c5d2*gd(i, 3, 1)+c5d3*gd(i, 4, 1)+c5d4*gd(i, 5, 1)+c5d5*gd(i, 6, 1&
&     )+c5d6*gd(i, 7, 1)+c5d7*gd(i, 8, 1)+c5d8*gd(i, 9, 1)+c5d9*gd(i, 10&
&     , 1)+c5d10*gd(i, 11, 1))
    fxrou2d = nx(i, j, 2)*(c5d0*fd(i, 1, 2)+c5d1*fd(i, 2, 2)+c5d2*fd(i, &
&     3, 2)+c5d3*fd(i, 4, 2)+c5d4*fd(i, 5, 2)+c5d5*fd(i, 6, 2)+c5d6*fd(i&
&     , 7, 2)+c5d7*fd(i, 8, 2)+c5d8*fd(i, 9, 2)+c5d9*fd(i, 10, 2)+c5d10*&
&     fd(i, 11, 2)) + ny(i, j, 2)*(c5d0*gd(i, 1, 2)+c5d1*gd(i, 2, 2)+&
&     c5d2*gd(i, 3, 2)+c5d3*gd(i, 4, 2)+c5d4*gd(i, 5, 2)+c5d5*gd(i, 6, 2&
&     )+c5d6*gd(i, 7, 2)+c5d7*gd(i, 8, 2)+c5d8*gd(i, 9, 2)+c5d9*gd(i, 10&
&     , 2)+c5d10*gd(i, 11, 2))
    fxrov2d = nx(i, j, 2)*(c5d0*fd(i, 1, 3)+c5d1*fd(i, 2, 3)+c5d2*fd(i, &
&     3, 3)+c5d3*fd(i, 4, 3)+c5d4*fd(i, 5, 3)+c5d5*fd(i, 6, 3)+c5d6*fd(i&
&     , 7, 3)+c5d7*fd(i, 8, 3)+c5d8*fd(i, 9, 3)+c5d9*fd(i, 10, 3)+c5d10*&
&     fd(i, 11, 3)) + ny(i, j, 2)*(c5d0*gd(i, 1, 3)+c5d1*gd(i, 2, 3)+&
&     c5d2*gd(i, 3, 3)+c5d3*gd(i, 4, 3)+c5d4*gd(i, 5, 3)+c5d5*gd(i, 6, 3&
&     )+c5d6*gd(i, 7, 3)+c5d7*gd(i, 8, 3)+c5d8*gd(i, 9, 3)+c5d9*gd(i, 10&
&     , 3)+c5d10*gd(i, 11, 3))
    fxrow2d = nx(i, j, 2)*(c5d0*fd(i, 1, 4)+c5d1*fd(i, 2, 4)+c5d2*fd(i, &
&     3, 4)+c5d3*fd(i, 4, 4)+c5d4*fd(i, 5, 4)+c5d5*fd(i, 6, 4)+c5d6*fd(i&
&     , 7, 4)+c5d7*fd(i, 8, 4)+c5d8*fd(i, 9, 4)+c5d9*fd(i, 10, 4)+c5d10*&
&     fd(i, 11, 4)) + ny(i, j, 2)*(c5d0*gd(i, 1, 4)+c5d1*gd(i, 2, 4)+&
&     c5d2*gd(i, 3, 4)+c5d3*gd(i, 4, 4)+c5d4*gd(i, 5, 4)+c5d5*gd(i, 6, 4&
&     )+c5d6*gd(i, 7, 4)+c5d7*gd(i, 8, 4)+c5d8*gd(i, 9, 4)+c5d9*gd(i, 10&
&     , 4)+c5d10*gd(i, 11, 4))
    fxroe2d = nx(i, j, 2)*(c5d0*fd(i, 1, 5)+c5d1*fd(i, 2, 5)+c5d2*fd(i, &
&     3, 5)+c5d3*fd(i, 4, 5)+c5d4*fd(i, 5, 5)+c5d5*fd(i, 6, 5)+c5d6*fd(i&
&     , 7, 5)+c5d7*fd(i, 8, 5)+c5d8*fd(i, 9, 5)+c5d9*fd(i, 10, 5)+c5d10*&
&     fd(i, 11, 5)) + ny(i, j, 2)*(c5d0*gd(i, 1, 5)+c5d1*gd(i, 2, 5)+&
&     c5d2*gd(i, 3, 5)+c5d3*gd(i, 4, 5)+c5d4*gd(i, 5, 5)+c5d5*gd(i, 6, 5&
&     )+c5d6*gd(i, 7, 5)+c5d7*gd(i, 8, 5)+c5d8*gd(i, 9, 5)+c5d9*gd(i, 10&
&     , 5)+c5d10*gd(i, 11, 5))
    predro1d = d4*wd(i-4, j, 1) - d5*wd(i-5, j, 1) - d3*wd(i-3, j, 1) + &
&     d2*wd(i-2, j, 1) - d1*wd(i-1, j, 1) + d1*wd(i, j, 1) - d2*wd(i+1, &
&     j, 1) + d3*wd(i+2, j, 1) + d5*wd(i+4, j, 1) - d4*wd(i+3, j, 1)
...
! #include "rhs/spectralradiusRossow_i.F"
!1st direction
    k_sensor1d = (abs20d-abs20*abs46d/abs46)/abs46
    ...
    ELSE
      ...
      abs47 = -x25
    END IF
    k_sensor2d = (abs21d-abs21*abs47d/abs47)/abs47
...
! #include "rhs/spectralradiusRossow_j.F"
! 2nd direction
    k_sensor1d = (abs22d-abs22*abs48d/abs48)/abs48
    ...
    ELSE
      ...
      abs49 = -x27
    END IF
    k_sensor2d = (abs23d-abs23*abs49d/abs49)/abs49
...
&     , 7, 1)+c3d7*fd(i, 8, 1)+c3d8*fd(i, 9, 1)+c3d9*fd(i, 10, 1)+c3d10*&
&     fd(i, 11, 1)) + ny(i, j, 2)*(c3d0*gd(i, 1, 1)+c3d1*gd(i, 2, 1)+&
&     c3d2*gd(i, 3, 1)+c3d3*gd(i, 4, 1)+c3d4*gd(i, 5, 1)+c3d5*gd(i, 6, 1&
&     )+c3d6*gd(i, 7, 1)+c3d7*gd(i, 8, 1)+c3d8*gd(i, 9, 1)+c3d9*gd(i, 10&
&     , 1)+c3d10*gd(i, 11, 1))
    fxrou2d = nx(i, j, 2)*(c3d0*fd(i, 1, 2)+c3d1*fd(i, 2, 2)+c3d2*fd(i, &
&     3, 2)+c3d3*fd(i, 4, 2)+c3d4*fd(i, 5, 2)+c3d5*fd(i, 6, 2)+c3d6*fd(i&
&     , 7, 2)+c3d7*fd(i, 8, 2)+c3d8*fd(i, 9, 2)+c3d9*fd(i, 10, 2)+c3d10*&
&     fd(i, 11, 2)) + ny(i, j, 2)*(c3d0*gd(i, 1, 2)+c3d1*gd(i, 2, 2)+&
&     c3d2*gd(i, 3, 2)+c3d3*gd(i, 4, 2)+c3d4*gd(i, 5, 2)+c3d5*gd(i, 6, 2&
&     )+c3d6*gd(i, 7, 2)+c3d7*gd(i, 8, 2)+c3d8*gd(i, 9, 2)+c3d9*gd(i, 10&
&     , 2)+c3d10*gd(i, 11, 2))
    fxrov2d = nx(i, j, 2)*(c3d0*fd(i, 1, 3)+c3d1*fd(i, 2, 3)+c3d2*fd(i, &
&     3, 3)+c3d3*fd(i, 4, 3)+c3d4*fd(i, 5, 3)+c3d5*fd(i, 6, 3)+c3d6*fd(i&
&     , 7, 3)+c3d7*fd(i, 8, 3)+c3d8*fd(i, 9, 3)+c3d9*fd(i, 10, 3)+c3d10*&
&     fd(i, 11, 3)) + ny(i, j, 2)*(c3d0*gd(i, 1, 3)+c3d1*gd(i, 2, 3)+&
&     c3d2*gd(i, 3, 3)+c3d3*gd(i, 4, 3)+c3d4*gd(i, 5, 3)+c3d5*gd(i, 6, 3&
&     )+c3d6*gd(i, 7, 3)+c3d7*gd(i, 8, 3)+c3d8*gd(i, 9, 3)+c3d9*gd(i, 10&
&     , 3)+c3d10*gd(i, 11, 3))
    fxrow2d = nx(i, j, 2)*(c3d0*fd(i, 1, 4)+c3d1*fd(i, 2, 4)+c3d2*fd(i, &
&     3, 4)+c3d3*fd(i, 4, 4)+c3d4*fd(i, 5, 4)+c3d5*fd(i, 6, 4)+c3d6*fd(i&
&     , 7, 4)+c3d7*fd(i, 8, 4)+c3d8*fd(i, 9, 4)+c3d9*fd(i, 10, 4)+c3d10*&
&     fd(i, 11, 4)) + ny(i, j, 2)*(c3d0*gd(i, 1, 4)+c3d1*gd(i, 2, 4)+&
&     c3d2*gd(i, 3, 4)+c3d3*gd(i, 4, 4)+c3d4*gd(i, 5, 4)+c3d5*gd(i, 6, 4&
&     )+c3d6*gd(i, 7, 4)+c3d7*gd(i, 8, 4)+c3d8*gd(i, 9, 4)+c3d9*gd(i, 10&
&     , 4)+c3d10*gd(i, 11, 4))
    fxroe2d = nx(i, j, 2)*(c3d0*fd(i, 1, 5)+c3d1*fd(i, 2, 5)+c3d2*fd(i, &
&     3, 5)+c3d3*fd(i, 4, 5)+c3d4*fd(i, 5, 5)+c3d5*fd(i, 6, 5)+c3d6*fd(i&
&     , 7, 5)+c3d7*fd(i, 8, 5)+c3d8*fd(i, 9, 5)+c3d9*fd(i, 10, 5)+c3d10*&
&     fd(i, 11, 5)) + ny(i, j, 2)*(c3d0*gd(i, 1, 5)+c3d1*gd(i, 2, 5)+&
&     c3d2*gd(i, 3, 5)+c3d3*gd(i, 4, 5)+c3d4*gd(i, 5, 5)+c3d5*gd(i, 6, 5&
&     )+c3d6*gd(i, 7, 5)+c3d7*gd(i, 8, 5)+c3d8*gd(i, 9, 5)+c3d9*gd(i, 10&
&     , 5)+c3d10*gd(i, 11, 5))
    predro1d = d4*wd(i-4, j, 1) - d5*wd(i-5, j, 1) - d3*wd(i-3, j, 1) + &
&     d2*wd(i-2, j, 1) - d1*wd(i-1, j, 1) + d1*wd(i, j, 1) - d2*wd(i+1, &
&     j, 1) + d3*wd(i+2, j, 1) + d5*wd(i+4, j, 1) - d4*wd(i+3, j, 1)
...
! #include "rhs/spectralradiusRossow_i.F"
!1st direction
    k_sensor1d = (abs26d-abs26*abs50d/abs50)/abs50
    ...
    ELSE
      ...
      abs51 = -x29
    END IF
    k_sensor2d = (abs27d-abs27*abs51d/abs51)/abs51
...
! #include "rhs/spectralradiusRossow_j.F"
! 2nd direction
    k_sensor1d = (abs28d-abs28*abs52d/abs52)/abs52
    ...
    ELSE
      ...
      abs53 = -x31
    END IF
    k_sensor2d = (abs29d-abs29*abs53d/abs53)/abs53
...
! #include "rhs/spectralradiusRossow_i.F"
!1st direction
    k_sensor1d = (abs31d-abs31*abs54d/abs54)/abs54
    ...
    ELSE
      ...
      abs55 = -x33
    END IF
    k_sensor2d = (abs32d-abs32*abs55d/abs55)/abs55
...
&       grad_temp(i, j, 2)*lambdad + lambda*grad_tempd(i, j, 2)
      ...
      residud(i, j, 1) = hnd(i, j, 1, 1) - hnd(i+1, j, 1, 1) - src1d + &
&       hnd(i, j, 1, 2) - hnd(i, j+1, 1, 2)
      residud(i, j, 2) = hnd(i, j, 2, 1) - hnd(i+1, j, 2, 1) - src2d + &
&       hnd(i, j, 2, 2) - hnd(i, j+1, 2, 2)
      residud(i, j, 3) = hnd(i, j, 3, 1) - hnd(i+1, j, 3, 1) - src3d + &
&       hnd(i, j, 3, 2) - hnd(i, j+1, 3, 2)
      residud(i, j, 4) = hnd(i, j, 4, 1) - hnd(i+1, j, 4, 1) - src4d + &
&       hnd(i, j, 4, 2) - hnd(i, j+1, 4, 2)
      residud(i, j, 5) = hnd(i, j, 5, 1) - hnd(i+1, j, 5, 1) - src5d + &
&       hnd(i, j, 5, 2) - hnd(i, j+1, 5, 2)
    END DO
  END DO
END SUBROUTINE FLUX_NUM_DNC9_POLAR_2D_D
!
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
