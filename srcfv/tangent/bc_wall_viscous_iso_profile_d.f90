...
!                gam:in
SUBROUTINE BC_WALL_VISCOUS_ISO_PROFILE_2D_D(w, wd, twallprof, twallprofd&
& , loc, gam, gamd, rgaz, rgazd, interf, gh, im, jm, lm)
  IMPLICIT NONE
!
!
...
!!
!! ???
    temp = pw/(rgaz*twallprof(l))
    roid = two*(pwd-temp*(twallprof(l)*rgazd+rgaz*twallprofd(l)))/(rgaz*&
&     twallprof(l)) - roed
    roi = two*temp - roe
! pi  = pw
...
! roiei = w(i+de*i0,j+de*j0,5)
    ...
    END DO
  END DO
END SUBROUTINE BC_WALL_VISCOUS_ISO_PROFILE_2D_D
!
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
