...
SUBROUTINE BC_WALL_VISCOUS_ADIA_2D_D(w, wd, loc, gam, interf, gh, im, jm&
&)
  IMPLICIT NONE
!
!
...
! roiei  = pi/gam1 + HALF*roi*(ui*ui+vi*vi+wi*wi)
    temp = ui*ui + vi*vi
    roieid = pid/gam1 + half*(temp*roid+roi*(2*ui*uid+2*vi*vid))
...
! ve21  = ue1*ue1 + ve1*ve1 + we1*we1
    ...
    END DO
  END DO
END SUBROUTINE BC_WALL_VISCOUS_ADIA_2D_D
!
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
