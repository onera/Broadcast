...
! =============================================================================
!
subroutine flux_num_dnc5_maxSC_2d(residu,w,x0,y0,nx,ny,xc,yc,vol,volf,gh,cp,cv,prandtl,&
  ...
  real(8) :: predro2,predrou2,predrov2,predrow2,predroe2, rspec, rspecbis
...
#include "rhs/dissipation_ducros_maxSC.F"
...
#include "rhs/fluxnumassembly_j.F"  
  ...
  ! fluxes balance
#include "rhs/balanceloop.F"


end subroutine flux_num_dnc5_maxSC_2d
!
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
