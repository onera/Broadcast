...
!
!  Differentiation of flux_num_dnc5_spongeref_up_2d in reverse (adjoint) mode (with options with!SliceDeadControl with!SliceDeadI
...
! =============================================================================
!
SUBROUTINE FLUX_NUM_DNC5_SPONGEREF_UP_2D_B(residu, residub, w, wb, x0, &
& y0, nx, ny, xc, yc, vol, volf, gh, cp, cv, prandtl, gam, rgaz, cs, &
& muref, tref, s_suth, k2, k4, im, jm, lmax, r3, r4, wref, sourcear, &
& sourcearb)
  IMPLICIT NONE
...
&     nx(i, j, 2)*volf(i, j, 2)*uxb
    ...
    sourcearb(i, j, :) = 0.0_8
    wb(i, j, :) = wb(i, j, :) + r4*ralpha*vol(i, j)*sourceb
...
&       (i, j)
    ...
    END DO
  END DO
END SUBROUTINE FLUX_NUM_DNC5_SPONGEREF_UP_2D_B
!
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
