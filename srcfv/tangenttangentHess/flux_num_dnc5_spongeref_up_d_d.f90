...
!
!  Differentiation of flux_num_dnc5_spongeref_up_2d_d in forward (tangent) mode (with options with!SliceDeadControl with!SliceDea
...
!  Tapenade 3.16 (master) -  9 Oct 2020 17:47
!
!  Differentiation of flux_num_dnc5_spongeref_up_2d in forward (tangent) mode (with options with!SliceDeadControl with!SliceDeadI
!nstrs with!StaticTaping):
!   variations   of useful results: residu
!   with respect to varying inputs: w
!   RW status of diff variables: w:in residu:out sourcear:(loc)
...
! =============================================================================
!
SUBROUTINE FLUX_NUM_DNC5_SPONGEREF_UP_2D_D_D(residu, residud, residudd, &
& w, wd0, wd, x0, y0, nx, ny, xc, yc, vol, volf, gh, cp, cv, prandtl, &
& gam, rgaz, cs, muref, tref, s_suth, k2, k4, im, jm, lmax, r3, r4, wref&
& , sourcear, sourceard)
  IMPLICIT NONE
...
&       , j, 5, 2) - hndd(i, j+1, 5, 2)
    END DO
  END DO
END SUBROUTINE FLUX_NUM_DNC5_SPONGEREF_UP_2D_D_D
!
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
