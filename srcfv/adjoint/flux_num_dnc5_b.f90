...
!
!  Differentiation of flux_num_dnc5_2d in reverse (adjoint) mode (with options with!SliceDeadControl with!SliceDeadInstrs with!St
!aticTaping):
...
! =============================================================================
!
SUBROUTINE FLUX_NUM_DNC5_2D_B(residu, residub, w, wb, x0, y0, nx, ny, xc&
...
&       (i, j)
    ...
    END DO
  END DO
END SUBROUTINE FLUX_NUM_DNC5_2D_B
!
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
