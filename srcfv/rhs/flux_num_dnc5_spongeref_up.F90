...
! =============================================================================
!
subroutine flux_num_dnc5_spongeref_up_2d(residu,w,x0,y0,nx,ny,xc,yc,vol,volf,gh,cp,cv,prandtl,&
                            gam,rgaz,cs,muref,tref,s_suth,k2,k4,im,jm, Lmax, r3, r4, wref, sourcear)
  !
  implicit none
  ...
  real(8),dimension(1-gh:im+gh  ,1-gh:jm+gh  , 5   ),intent(in) :: wref
  real(8),intent(in) :: Lmax, r4, r3
  ! Returned objects ------------------------------------------------
  real(8),dimension(1-gh:im+gh  ,1-gh:jm+gh  , 5   ),intent(inout) :: residu
  real(8),dimension(1-gh:im+gh  ,1-gh:jm+gh  , 5   ),intent(inout) :: sourcear
  ...
  real(8) :: HALF,ONE,ZERO,TWO,TWOTHIRD,FOURTH,TWELFTH,cvm1,TWELVE
...
#include "rhs/predictor_7p.F"
#include "rhs/flux_visqueux_o4.F"
#include "rhs/dissipation_ducros.F"
#include "rhs/relaxation_ref_up.F" 
...
#include "rhs/euler_o6_i.F"  
    ! Saunier Thesis                          
#include "rhs/nearbndfluxes5demi_7p.F"
#include "rhs/predictor_7p.F"
#include "rhs/flux_visqueux_o4.F"
#include "rhs/dissipation_ducros.F"   
#include "rhs/relaxation_ref_up.F" 
...
#include "rhs/euler_o6_i.F"
    ! Saunier Thesis                          
#include "rhs/nearbndfluxes3demi_7p.F"
#include "rhs/predictor_7p.F"
#include "rhs/flux_visqueux_o2.F"
#include "rhs/dissipation_ducros.F"
#include "rhs/relaxation_ref_up.F" 
#include "rhs/fluxnumassembly_i.F"
#include "rhs/fluxnumassembly_j.F"  
...
#include "rhs/euler_o6_i.F"
#include "rhs/predictor_7p_i.F"
#include "rhs/flux_visqueux_o2_i.F"
#include "rhs/dissipation_ducros_i.F"
#include "rhs/relaxation_ref_up.F" 
#include "rhs/fluxnumassembly_i.F"
#include "rhs/fluxwall.F"   

  
  enddo 
  
  ! fluxes balance
#include "rhs/balance_source.F"



end subroutine flux_num_dnc5_spongeref_up_2d
!
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
