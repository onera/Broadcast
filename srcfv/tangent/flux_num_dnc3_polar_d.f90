...
!
!1st direction
      k_sensor1d = (abs0d-abs0*abs10d/abs10)/abs10
      ...
      ELSE
        ...
        abs11 = -x7
      END IF
      k_sensor2d = (abs1d-abs1*abs11d/abs11)/abs11
...
!                 k_sensor2*ducros2*dxm2)
      coefd = max11*(max6*max1d+max1*max6d) + max1*max6*max11d
...
!
! 2nd direction
      k_sensor1d = (abs2d-abs2*abs12d/abs12)/abs12
      ...
      ELSE
        ...
        abs13 = -x9
      END IF
      k_sensor2d = (abs3d-abs3*abs13d/abs13)/abs13
...
!coef      = MAX( k_sensor1*ducros1*dxm1, &
!                 k_sensor2*ducros2*dxm2)
      coefd = max12*(max7*max2d+max2*max7d) + max2*max7*max12d
...
!
!1st direction
    k_sensor1d = (abs4d-abs4*abs14d/abs14)/abs14
    ...
    ELSE
      ...
      abs15 = -x11
    END IF
    k_sensor2d = (abs5d-abs5*abs15d/abs15)/abs15
...
!coef      = MAX( k_sensor1*ducros1*dxm1, &
!                 k_sensor2*ducros2*dxm2)
    coefd = max13*(max8*max3d+max3*max8d) + max3*max8*max13d
...
!
! 2nd direction
    k_sensor1d = (abs6d-abs6*abs16d/abs16)/abs16
    ...
    ELSE
      ...
      abs17 = -x13
    END IF
    k_sensor2d = (abs7d-abs7*abs17d/abs17)/abs17
...
!coef      = MAX( k_sensor1*ducros1*dxm1, &
!                 k_sensor2*ducros2*dxm2)
    coefd = max14*(max9*max4d+max4*max9d) + max4*max9*max14d
...
!
!1st direction
    k_sensor1d = (abs8d-abs8*abs18d/abs18)/abs18
    ...
    ELSE
      ...
      abs19 = -x15
    END IF
    k_sensor2d = (abs9d-abs9*abs19d/abs19)/abs19
...
!coef      = MAX( k_sensor1*ducros1*dxm1, &
!                 k_sensor2*ducros2*dxm2)
    coefd = max15*(max10*max5d+max5*max10d) + max5*max10*max15d
