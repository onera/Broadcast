...
!
!  Differentiation of flux_num_dnc3_nowall_2d in reverse (adjoint) mode (with options with!SliceDeadControl with!SliceDeadInstrs 
!with!StaticTaping):
...
! =============================================================================
!
SUBROUTINE FLUX_NUM_DNC3_NOWALL_2D_B(residu, residub, w, wb, x0, y0, nx&
...
&       diffro+eps4*predro2)*dissro2b
      ...
      END IF
      coefb = k2*eps2b
      max2b = max4*max6*coefb
      max4b = max2*max6*coefb
      max6b = max2*max4*coefb
...
&       diffro+eps4*predro1)*dissro1b
      ...
      coefb = k2*eps2b
      max1b = max3*max5*coefb
      max3b = max1*max5*coefb
      max5b = max1*max3*coefb
...
&       (i, j)
    ...
    END DO
  END DO
END SUBROUTINE FLUX_NUM_DNC3_NOWALL_2D_B
!
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
