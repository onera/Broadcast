...
!
!  Differentiation of flux_num_dnc5_sponge_up_2d_d in forward (tangent) mode (with options with!SliceDeadControl with!SliceDeadIn
!strs with!StaticTaping):
...
!  Tapenade 3.16 (master) -  9 Oct 2020 17:47
!
!  Differentiation of flux_num_dnc5_sponge_up_2d in forward (tangent) mode (with options with!SliceDeadControl with!SliceDeadInst
!rs with!StaticTaping):
...
! =============================================================================
!
SUBROUTINE FLUX_NUM_DNC5_SPONGE_UP_2D_D_D(residu, residud, residudd, w, &
& wd0, wd, x0, y0, nx, ny, xc, yc, vol, volf, gh, cp, cv, prandtl, gam, &
& rgaz, cs, muref, tref, s_suth, k2, k4, im, jm, lmax, r2, r3, r4, &
& sourcear, sourceard)
  IMPLICIT NONE
...
& gradmu
  ...
  REAL*8, DIMENSION(5) :: wmoyd, sourced
  INTEGER :: i, j, h
...
&       , j, 5, 2) - hndd(i, j+1, 5, 2)
    END DO
  END DO
END SUBROUTINE FLUX_NUM_DNC5_SPONGE_UP_2D_D_D
!
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
