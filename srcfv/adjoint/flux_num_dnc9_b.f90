...
&     *dissro1b
    ...
    IF (ad_branch97 .EQ. 0) eps2b = eps2b - 12.d0*eps4b
    coefb = k2*eps2b
    max11b = max22*max33*coefb
    max22b = max11*max33*coefb
    max33b = max11*max22*coefb
    IF (ad_branch96 .EQ. 0) THEN
      dxm2b = max33b
      dxm1b = 0.0_8
    ELSE
      dxm1b = max33b
...
&     *dissro2b
    ...
    END IF
    coefb = k2*eps2b
    max10b = max21*max32*coefb
    max21b = max10*max32*coefb
    max32b = max10*max21*coefb
    IF (ad_branch87 .EQ. 0) THEN
      dxm2b = max32b
      dxm1b = 0.0_8
    ELSE
      dxm1b = max32b
...
&     *dissro1b
    ...
    coefb = k2*eps2b
    max9b = max20*max31*coefb
    max20b = max9*max31*coefb
    max31b = max9*max20*coefb
...
&     *dissro2b
    ...
    END IF
    coefb = k2*eps2b
    max8b = max19*max30*coefb
    max19b = max8*max30*coefb
    max30b = max8*max19*coefb
...
&     *dissro1b
    ...
    coefb = k2*eps2b
    max7b = max18*max29*coefb
    max18b = max7*max29*coefb
    max29b = max7*max18*coefb
...
&     *dissro2b
    ...
    END IF
    coefb = k2*eps2b
    max6b = max17*max28*coefb
    max17b = max6*max28*coefb
    max28b = max6*max17*coefb
...
&     *dissro1b
    ...
    coefb = k2*eps2b
    max5b = max16*max27*coefb
    max16b = max5*max27*coefb
    max27b = max5*max16*coefb
...
&     *dissro2b
    ...
    END IF
    coefb = k2*eps2b
    max4b = max15*max26*coefb
    max15b = max4*max26*coefb
    max26b = max4*max15*coefb
...
&     *dissro1b
    ...
    coefb = k2*eps2b
    max3b = max14*max25*coefb
    max14b = max3*max25*coefb
    max25b = max3*max14*coefb
...
&       diffro+eps4*predro2)*dissro2b
      ...
      END IF
      coefb = k2*eps2b
      max2b = max13*max24*coefb
      max13b = max2*max24*coefb
      max24b = max2*max13*coefb
...
&       diffro+eps4*predro1)*dissro1b
      ...
      coefb = k2*eps2b
      max1b = max12*max23*coefb
      max12b = max1*max23*coefb
      max23b = max1*max12*coefb
