...
!
!  Differentiation of bc_mirror_2d in reverse (adjoint) mode (with options with!SliceDeadControl with!SliceDeadInstrs with!Static
!Taping):
...
!                             BC mirror 2D
! =============================================================================
SUBROUTINE BC_MIRROR_2D_B(w, wb, loc, interf, nx, ny, gh, im, jm)
  IMPLICIT NONE
