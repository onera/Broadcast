...
! =============================================================================
!
SUBROUTINE FLUX_NUM_DNC5_POLAR_2D_D(residu, residud, w, wd, ym, x0, y0, &
...
!1st direction
      k_sensor1d = (abs2d-abs2*abs22d/abs22)/abs22
      ...
      ELSE
        ...
        abs23 = -x9
      END IF
      k_sensor2d = (abs3d-abs3*abs23d/abs23)/abs23
...
! 2nd direction
      k_sensor1d = (abs4d-abs4*abs24d/abs24)/abs24
      ...
      ELSE
        ...
        abs25 = -x11
      END IF
      k_sensor2d = (abs5d-abs5*abs25d/abs25)/abs25
...
! #include "rhs/spectralradiusRossow_i.F"
!1st direction
    k_sensor1d = (abs14d-abs14*abs30d/abs30)/abs30
    ...
    ELSE
      ...
      abs31 = -x17
    END IF
    k_sensor2d = (abs15d-abs15*abs31d/abs31)/abs31
...
! #include "rhs/spectralradiusRossow_j.F"
! 2nd direction
    k_sensor1d = (abs16d-abs16*abs32d/abs32)/abs32
    ...
    ELSE
      ...
      abs33 = -x19
    END IF
    k_sensor2d = (abs17d-abs17*abs33d/abs33)/abs33
...
! #include "rhs/spectralradiusRossow_i.F"
!1st direction
    k_sensor1d = (abs19d-abs19*abs34d/abs34)/abs34
    ...
    ELSE
      ...
      abs35 = -x21
    END IF
    k_sensor2d = (abs20d-abs20*abs35d/abs35)/abs35
...
&       hnd(i, j, 5, 2) - hnd(i, j+1, 5, 2)
    END DO
  END DO
END SUBROUTINE FLUX_NUM_DNC5_POLAR_2D_D
!
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
