...
! =============================================================================
!
subroutine flux_num_dnc7_euler_nowall_2d(residu,w,x0,y0,nx,ny,xc,yc,vol,gh,cp,cv,&
                                         gam,rgaz,k2,k4,im,jm)
!
  implicit none
! variables for dimension -----------------------------------------
  integer :: im,jm,gh
! required arguments ----------------------------------------------
  real(8),intent(in) :: cp,cv,gam,rgaz ! thermo
...
!
    ...
    dissroe2 = rspec * (eps2*diffroe + eps4*predroe2)
       ...
       hn(i,j,2,1) = fxrou1 - dissrou1 
       hn(i,j,3,1) = fxrov1 - dissrov1 
       hn(i,j,4,1) = fxrow1 - dissrow1 
       hn(i,j,5,1) = fxroe1 - dissroe1 
       
       
       hn(i,j,1,2) = fxro2  -  dissro2  
       hn(i,j,2,2) = fxrou2 - dissrou2 
       hn(i,j,3,2) = fxrov2 - dissrov2 
       hn(i,j,4,2) = fxrow2 - dissrow2 
       hn(i,j,5,2) = fxroe2 - dissroe2 
...
end subroutine flux_num_dnc7_euler_nowall_2d
!
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
