...
!
!  Differentiation of flux_num_dnc7_euler_nowall_2d_d in forward (tangent) mode (with options with!SliceDeadControl with!SliceDea
...
! =============================================================================
!
SUBROUTINE FLUX_NUM_DNC7_EULER_NOWALL_2D_D_D(residu, residud, residudd, &
& w, wd0, wd, x0, y0, nx, ny, xc, yc, vol, gh, cp, cv, gam, rgaz, k2, k4&
& , im, jm)
  IMPLICIT NONE
...
& dissrov2dd, dissrow1dd, dissrow2dd, dissroe1dd, dissroe2dd
  ...
  REAL*8 :: rod0, rom1d0, htotd0, elocd0, ecd0
  REAL*8 :: rod, rom1d, htotd, elocd, ecd
  REAL*8 :: rom1dd, htotdd, elocdd, ecdd
...
&       predroe2d0+predroe2*eps4dd+predroe2d*eps4d0)
      ...
      hndd(i, j, 2, 1) = fxrou1dd - dissrou1dd
      hndd(i, j, 3, 1) = fxrov1dd - dissrov1dd
      hndd(i, j, 4, 1) = fxrow1dd - dissrow1dd
      hndd(i, j, 5, 1) = fxroe1dd - dissroe1dd
      hndd(i, j, 1, 2) = fxro2dd - dissro2dd
      hndd(i, j, 2, 2) = fxrou2dd - dissrou2dd
      hndd(i, j, 3, 2) = fxrov2dd - dissrov2dd
      hndd(i, j, 4, 2) = fxrow2dd - dissrow2dd
      hndd(i, j, 5, 2) = fxroe2dd - dissroe2dd
    END DO
  END DO
  residudd = 0.0_8
!
...
&       , j, 5, 2) - hndd(i, j+1, 5, 2)
    END DO
  END DO
END SUBROUTINE FLUX_NUM_DNC7_EULER_NOWALL_2D_D_D
!
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
