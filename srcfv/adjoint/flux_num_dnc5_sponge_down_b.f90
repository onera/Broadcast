...
!
!  Differentiation of flux_num_dnc5_sponge_down_2d in reverse (adjoint) mode (with options with!SliceDeadControl with!SliceDeadIn
...
! =============================================================================
!
SUBROUTINE FLUX_NUM_DNC5_SPONGE_DOWN_2D_B(residu, residub, w, wb, x0, y0&
...
&       (i, j)
    ...
    END DO
  END DO
END SUBROUTINE FLUX_NUM_DNC5_SPONGE_DOWN_2D_B
!
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
