...
! =============================================================================
!
subroutine flux_num_dnc5_sponge_up_2d(residu,w,x0,y0,nx,ny,xc,yc,vol,volf,gh,cp,cv,prandtl,&
...
#include "rhs/relaxation_gaussian_up.F" 
...
end subroutine flux_num_dnc5_sponge_up_2d
!
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
