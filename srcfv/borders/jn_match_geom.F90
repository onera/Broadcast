...
subroutine jn_match_geom_2d(wr,prr,gh1r,gh2r,gh3r,gh4r,imr,jmr,&
  ...
  ! Output variables ------------------------------------------------
  real(8),dimension(1-gh1r:imr+gh2r,1-gh3r:jmr+gh4r),intent(inout) :: wr
  ! Local variables -------------------------------------------------
  ...
  enddo
  !
end subroutine jn_match_geom_2d

!===============================================================================
!                          JOIN Match for Normals
!===============================================================================
subroutine jn_match_face_geom_2d(fr,prr,gh1r,gh2r,gh3r,gh4r,imr,jmr,&
                                 fd,prd,gh1d,gh2d,gh3d,gh4d,imd,jmd,&
                                 locr,locd,tr,dimf)
  !
  implicit none
  ! Variables for dimension -----------------------------------------
  integer,intent(in) :: imr,jmr,imd,jmd,dimf
  integer,intent(in) :: gh1r,gh2r,gh3r,gh4r
  integer,intent(in) :: gh1d,gh2d,gh3d,gh4d
  ! Input variables -------------------------------------------------
  character(len=3),intent(in) :: locr,locd
  real(8),dimension(1-gh1d:imd+1+gh2d,1-gh3d:jmd+1+gh4d,dimf),intent(in) :: fd
  integer,dimension(2,2),intent(in) :: prr,prd
  integer,dimension(2),intent(in) :: tr
  ! Output variables ------------------------------------------------
  real(8),dimension(1-gh1r:imr+1+gh2r,1-gh3r:jmr+1+gh4r,dimf),intent(inout) :: fr
  ! Local variables -------------------------------------------------
  integer,pointer :: ind1,ind2
  integer :: ir,jr
  integer,target :: id,jd
  ...
  enddo
  !
end subroutine jn_match_face_geom_2d
!
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
