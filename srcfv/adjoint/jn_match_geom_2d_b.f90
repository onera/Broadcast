...
!
!  Differentiation of jn_match_geom_2d in reverse (adjoint) mode (with options with!SliceDeadControl with!SliceDeadInstrs with!St
!aticTaping):
...
! Join match 2-D
! =============================================================================
SUBROUTINE JN_MATCH_GEOM_2D_B(wr, wrb, prr, gh1r, gh2r, gh3r, gh4r, imr&
...
! Input variables -------------------------------------------------
  ...
  REAL*8, DIMENSION(1-gh1d:imd+gh2d, 1-gh3d:jmd+gh4d) :: wdb
...
END SUBROUTINE JN_MATCH_GEOM_2D_B
