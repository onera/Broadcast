...
!1st direction
      k_sensor1d = (abs2d-abs2*abs28d/abs28)/abs28
      ...
      ELSE
        ...
        abs29 = -x11
      END IF
      k_sensor2d = (abs3d-abs3*abs29d/abs29)/abs29
...
! 2nd direction
      k_sensor1d = (abs4d-abs4*abs30d/abs30)/abs30
      ...
      ELSE
        ...
        abs31 = -x13
      END IF
      k_sensor2d = (abs5d-abs5*abs31d/abs31)/abs31
...
! #include "rhs/spectralradiusRossow_i.F"
!1st direction
    k_sensor1d = (abs8d-abs8*abs32d/abs32)/abs32
    ...
    ELSE
      ...
      abs33 = -x15
    END IF
    k_sensor2d = (abs9d-abs9*abs33d/abs33)/abs33
...
! #include "rhs/spectralradiusRossow_j.F"
! 2nd direction
    k_sensor1d = (abs10d-abs10*abs34d/abs34)/abs34
    ...
    ELSE
      ...
      abs35 = -x17
    END IF
    k_sensor2d = (abs11d-abs11*abs35d/abs35)/abs35
...
! #include "rhs/spectralradiusRossow_i.F"
!1st direction
    k_sensor1d = (abs20d-abs20*abs40d/abs40)/abs40
    ...
    ELSE
      ...
      abs41 = -x23
    END IF
    k_sensor2d = (abs21d-abs21*abs41d/abs41)/abs41
...
! #include "rhs/spectralradiusRossow_j.F"
! 2nd direction
    k_sensor1d = (abs22d-abs22*abs42d/abs42)/abs42
    ...
    ELSE
      ...
      abs43 = -x25
    END IF
    k_sensor2d = (abs23d-abs23*abs43d/abs43)/abs43
...
! #include "rhs/spectralradiusRossow_i.F"
!1st direction
    k_sensor1d = (abs25d-abs25*abs44d/abs44)/abs44
    ...
    ELSE
      ...
      abs45 = -x27
    END IF
    k_sensor2d = (abs26d-abs26*abs45d/abs45)/abs45
