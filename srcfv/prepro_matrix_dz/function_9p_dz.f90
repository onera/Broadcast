...
!
    ...
    func0(i,j,3) = w(i,j,3) * velz(i,j) - mu(i,j) * gradw(i,j,2)
    func0(i,j,4) = w(i,j,4) * velz(i,j) + p(i,j) + TWOTHIRD * mu(i,j) * ( gradu(i,j,1) + gradv(i,j,2) )
    ...
    func9(i,j,3) = ZERO
    func9(i,j,4) = ZERO
    func9(i,j,5) = velx(i,j)

    func10(i,j,1) = ZERO
    func10(i,j,2) = ZERO
    func10(i,j,3) = ZERO
    func10(i,j,4) = ZERO
    func10(i,j,5) = mu(i,j) * gradw(i,j,1)

    func11(i,j,1) = ZERO
    func11(i,j,2) = ZERO
    func11(i,j,3) = ZERO
    func11(i,j,4) = ZERO
    func11(i,j,5) = vely(i,j)

    func12(i,j,1) = ZERO
    func12(i,j,2) = ZERO
    func12(i,j,3) = ZERO
    func12(i,j,4) = ZERO
    func12(i,j,5) = mu(i,j) * gradw(i,j,2)

    func13(i,j,1) = ZERO
    func13(i,j,2) = ZERO
    func13(i,j,3) = ZERO
    func13(i,j,4) = ZERO
    func13(i,j,5) = velz(i,j)
    ...
    func15(i,j,3) = ZERO
    func15(i,j,4) = ZERO
    func15(i,j,5) = gradu(i,j,1) + gradv(i,j,2)
