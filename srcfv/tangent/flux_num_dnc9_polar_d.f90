...
!
!1st direction
      k_sensor1d = (abs0d-abs0*abs22d/abs22)/abs22
      ...
      ELSE
        ...
        abs23 = -x13
      END IF
      k_sensor2d = (abs1d-abs1*abs23d/abs23)/abs23
...
!                 k_sensor2*ducros2*dxm2)
      coefd = max23*(max12*max1d+max1*max12d) + max1*max12*max23d
...
!
! 2nd direction
      k_sensor1d = (abs2d-abs2*abs24d/abs24)/abs24
      ...
      ELSE
        ...
        abs25 = -x15
      END IF
      k_sensor2d = (abs3d-abs3*abs25d/abs25)/abs25
...
!coef      = MAX( k_sensor1*ducros1*dxm1, &
!                 k_sensor2*ducros2*dxm2)
      coefd = max24*(max13*max2d+max2*max13d) + max2*max13*max24d
...
!
!1st direction
    k_sensor1d = (abs4d-abs4*abs26d/abs26)/abs26
    ...
    ELSE
      ...
      abs27 = -x17
    END IF
    k_sensor2d = (abs5d-abs5*abs27d/abs27)/abs27
...
!coef      = MAX( k_sensor1*ducros1*dxm1, &
!                 k_sensor2*ducros2*dxm2)
    coefd = max25*(max14*max3d+max3*max14d) + max3*max14*max25d
...
!
! 2nd direction
    k_sensor1d = (abs6d-abs6*abs28d/abs28)/abs28
    ...
    ELSE
      ...
      abs29 = -x19
    END IF
    k_sensor2d = (abs7d-abs7*abs29d/abs29)/abs29
...
!coef      = MAX( k_sensor1*ducros1*dxm1, &
!                 k_sensor2*ducros2*dxm2)
    coefd = max26*(max15*max4d+max4*max15d) + max4*max15*max26d
...
!
!1st direction
    k_sensor1d = (abs8d-abs8*abs30d/abs30)/abs30
    ...
    ELSE
      ...
      abs31 = -x21
    END IF
    k_sensor2d = (abs9d-abs9*abs31d/abs31)/abs31
...
!coef      = MAX( k_sensor1*ducros1*dxm1, &
!                 k_sensor2*ducros2*dxm2)
    coefd = max27*(max16*max5d+max5*max16d) + max5*max16*max27d
...
!
! 2nd direction
    k_sensor1d = (abs10d-abs10*abs32d/abs32)/abs32
    ...
    ELSE
      ...
      abs33 = -x23
    END IF
    k_sensor2d = (abs11d-abs11*abs33d/abs33)/abs33
...
!coef      = MAX( k_sensor1*ducros1*dxm1, &
!                 k_sensor2*ducros2*dxm2)
    coefd = max28*(max17*max6d+max6*max17d) + max6*max17*max28d
...
!
!1st direction
    k_sensor1d = (abs12d-abs12*abs34d/abs34)/abs34
    ...
    ELSE
      ...
      abs35 = -x25
    END IF
    k_sensor2d = (abs13d-abs13*abs35d/abs35)/abs35
...
!coef      = MAX( k_sensor1*ducros1*dxm1, &
!                 k_sensor2*ducros2*dxm2)
    coefd = max29*(max18*max7d+max7*max18d) + max7*max18*max29d
...
!
! 2nd direction
    k_sensor1d = (abs14d-abs14*abs36d/abs36)/abs36
    ...
    ELSE
      ...
      abs37 = -x27
    END IF
    k_sensor2d = (abs15d-abs15*abs37d/abs37)/abs37
...
!coef      = MAX( k_sensor1*ducros1*dxm1, &
!                 k_sensor2*ducros2*dxm2)
    coefd = max30*(max19*max8d+max8*max19d) + max8*max19*max30d
...
!
!1st direction
    k_sensor1d = (abs16d-abs16*abs38d/abs38)/abs38
    ...
    ELSE
      ...
      abs39 = -x29
    END IF
    k_sensor2d = (abs17d-abs17*abs39d/abs39)/abs39
...
!coef      = MAX( k_sensor1*ducros1*dxm1, &
!                 k_sensor2*ducros2*dxm2)
    coefd = max31*(max20*max9d+max9*max20d) + max9*max20*max31d
...
!
! 2nd direction
    k_sensor1d = (abs18d-abs18*abs40d/abs40)/abs40
    ...
    ELSE
      ...
      abs41 = -x31
    END IF
    k_sensor2d = (abs19d-abs19*abs41d/abs41)/abs41
...
!coef      = MAX( k_sensor1*ducros1*dxm1, &
!                 k_sensor2*ducros2*dxm2)
    coefd = max32*(max21*max10d+max10*max21d) + max10*max21*max32d
...
!
!1st direction
    k_sensor1d = (abs20d-abs20*abs42d/abs42)/abs42
    ...
    ELSE
      ...
      abs43 = -x33
    END IF
    k_sensor2d = (abs21d-abs21*abs43d/abs43)/abs43
...
!coef      = MAX( k_sensor1*ducros1*dxm1, &
!                 k_sensor2*ducros2*dxm2)
    coefd = max33*(max22*max11d+max11*max22d) + max11*max22*max33d
