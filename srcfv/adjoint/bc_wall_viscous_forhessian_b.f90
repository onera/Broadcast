...
!
!  Differentiation of bc_wall_viscous_adia_forhessian_2d in reverse (adjoint) mode (with options with!SliceDeadControl with!Slice
...
SUBROUTINE BC_WALL_VISCOUS_ADIA_FORHESSIAN_2D_B(wout, woutb, w, wb, loc&
& , gam, interf, gh, im, jm)
  IMPLICIT NONE
!
!
...
&       + w(i+de*i0, j+de*j0, 2)*ue1b
      ...
      roieib = woutb(i-de*i0, j-de*j0, 5)
      woutb(i-de*i0, j-de*j0, 5) = 0.0_8
      roib = wi*woutb(i-de*i0, j-de*j0, 4) + vi*woutb(i-de*i0, j-de*j0, &
&       3) + ui*woutb(i-de*i0, j-de*j0, 2) + woutb(i-de*i0, j-de*j0, 1)
      wib = roi*woutb(i-de*i0, j-de*j0, 4)
      woutb(i-de*i0, j-de*j0, 4) = 0.0_8
      vib = roi*woutb(i-de*i0, j-de*j0, 3)
      woutb(i-de*i0, j-de*j0, 3) = 0.0_8
      uib = roi*woutb(i-de*i0, j-de*j0, 2)
...
&       roe**2
  ...
  wb = wb + woutb
  woutb = 0.0_8
END SUBROUTINE BC_WALL_VISCOUS_ADIA_FORHESSIAN_2D_B
!
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
