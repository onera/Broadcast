...
! =============================================================================
!
SUBROUTINE FLUX_NUM_DNC9_NOWALL_POLAR_2D_D(residu, residud, w, wd, ym, &
...
!1st direction
      k_sensor1d = (abs2d-abs2*abs7d/abs7)/abs7
      k_sensor1 = abs2/abs7
      ...
      ELSE
        ...
        abs8 = -x4
      END IF
      k_sensor2d = (abs3d-abs3*abs8d/abs8)/abs8
      k_sensor2 = abs3/abs8
...
! 2nd direction
      k_sensor1d = (abs4d-abs4*abs9d/abs9)/abs9
      k_sensor1 = abs4/abs9
      ...
      ELSE
        ...
        abs10 = -x6
      END IF
      k_sensor2d = (abs5d-abs5*abs10d/abs10)/abs10
...
&       hnd(i, j, 5, 2) - hnd(i, j+1, 5, 2)
    END DO
  END DO
END SUBROUTINE FLUX_NUM_DNC9_NOWALL_POLAR_2D_D
!
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
